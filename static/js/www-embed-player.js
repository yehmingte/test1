...
c.prototype=b.prototype;a.ba=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Xo=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
;var af={Ho:"WEB_DISPLAY_MODE_UNKNOWN",Do:"WEB_DISPLAY_MODE_BROWSER",Fo:"WEB_DISPLAY_MODE_MINIMAL_UI",Go:"WEB_DISPLAY_MODE_STANDALONE",Eo:"WEB_DISPLAY_MODE_FULLSCREEN"};function bf(){this.data_=[];this.i=-1}
...
null==(u=Ad.screen)?void 0:u.availWidth;var B;e.u_cd=null==(B=Ad.screen)?void 0:B.colorDepth}catch(ua){}h=b.i;try{var v=h.screenX;var E=h.screenY}catch(ua){}try{var F=h.outerWidth;var H=h.outerHeight}catch(ua){}try{var R=h.innerWidth;var O=h.innerHeight}catch(ua){}try{var S=h.screenLeft;var ja=h.screenTop}catch(ua){}try{R=h.innerWidth,O=h.innerHeight}catch(ua){}try{var N=h.screen.availWidth;var Ba=h.screen.availTop}catch(ua){}v=[S,ja,v,E,N,Ba,F,H,R,O];try{var Oa=(b.i.top||window).document,va="CSS1Compat"==
Oa.compatMode?Oa.documentElement:Oa.body;var G=(new Id(va.clientWidth,va.clientHeight)).round()}catch(ua){G=new Id(-12245933,-12245933)}Oa=G;G={};var Ca=void 0===Ca?x:Ca;va=new bf;Ca.SVGElement&&Ca.document.createElementNS&&va.set(0);E=Qd();E["allow-top-navigation-by-user-activation"]&&va.set(1);E["allow-popups-to-escape-sandbox"]&&va.set(2);Ca.crypto&&Ca.crypto.subtle&&va.set(3);Ca.TextDecoder&&Ca.TextEncoder&&va.set(4);Ca=cf(va);G.bc=Ca;G.bih=Oa.height;G.biw=Oa.width;G.brdim=v.join();b=b.j;b=(G.vis=
...
function vj(a,b,c){c=void 0===c?{}:c;var d={};M("enable_web_eom_visitor_data")&&A("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":A("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||A("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Wo||A("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().Vo:b=me([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=A("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=A("DELEGATED_SESSION_ID")));return d}
...
function Wk(a,b){if(!b)throw ok("openWithToken",ck(a.name));return Xk(a)}
function Xk(a){function b(){var f,g,h,k,m,q,u,B,v,E;return w(function(F){switch(F.i){case 1:return g=null!=(f=Error().stack)?f:"",wa(F,2),t(F,a.l(a.name,a.options.version,d),4);case 4:h=F.j;for(var H=a.options,R=[],O=p(Object.keys(H.ya)),S=O.next();!S.done;S=O.next()){S=S.value;var ja=H.ya[S],N=void 0===ja.jc?Number.MAX_VALUE:ja.jc;!(h.i.version>=ja.Wa)||h.i.version>=N||h.i.objectStoreNames.contains(S)||R.push(S)}k=R;if(0===k.length){F.u(5);break}m=Object.keys(a.options.ya);q=h.objectStoreNames();
if(a.o<Nh("ytidb_reopen_db_retries",0))return a.o++,h.close(),Xj(new jk("DB_REOPENED_BY_MISSING_OBJECT_STORES",{dbName:a.name,expectedObjectStores:m,foundObjectStores:q})),F.return(b());if(!(a.s<Nh("ytidb_remake_db_retries",1))){F.u(6);break}a.s++;if(!M("ytidb_remake_db_enable_backoff_delay")){F.u(7);break}return t(F,Tk(a.j),8);case 8:a.j*=2;case 7:return t(F,a.delete(),9);case 9:return Xj(new jk("DB_DELETED_BY_MISSING_OBJECT_STORES",{dbName:a.name,expectedObjectStores:m,foundObjectStores:q})),F.return(b());
case 6:throw new kk(q,m);case 5:return F.return(h);case 2:u=ya(F);if(u instanceof DOMException?"VersionError"!==u.name:"DOMError"in self&&u instanceof DOMError?"VersionError"!==u.name:!(u instanceof Object&&"message"in u)||"An attempt was made to open a database using a lower version than the existing version."!==u.message){F.u(10);break}return t(F,a.l(a.name,void 0,Object.assign({},d,{upgrade:void 0})),11);case 11:B=F.j;v=B.i.version;if(void 0!==a.options.version&&v>a.options.version+1)throw B.close(),
a.m=!1,Vk(a,v);return F.return(B);case 10:throw c(),u instanceof Error&&!M("ytidb_async_stack_killswitch")&&(u.stack=u.stack+"\n"+g.substring(g.indexOf("\n")+1)),nk(u,a.name,"",null!=(E=a.options.version)?E:-1);}})}
function c(){a.i===e&&(a.i=void 0)}
if(!a.m)throw Vk(a);if(a.i)return a.i;var d={blocking:function(f){f.close()},
closed:c,Ac:c,upgrade:a.options.upgrade};var e=b();a.i=e;return a.i}
;var Yk=new Uk("YtIdbMeta",{ya:{databases:{Wa:1}},upgrade:function(a,b){b(1)&&Dk(a,"databases",{keyPath:"actualName"})}});
function Zk(a,b){var c;return w(function(d){if(1==d.i)return t(d,Wk(Yk,b),2);c=d.j;return d.return(Ck(c,["databases"],{S:!0,mode:"readwrite"},function(e){var f=e.objectStore("databases");return f.get(a.actualName).then(function(g){if(g?a.actualName!==g.actualName||a.publicName!==g.publicName||a.userIdentifier!==g.userIdentifier:1)return zk(f.i.put(a,void 0)).then(function(){})})}))})}
function $k(a,b){var c;return w(function(d){if(1==d.i)return a?t(d,Wk(Yk,b),2):d.return();c=d.j;return d.return(c.delete("databases",a))})}
function al(a,b){var c,d;return w(function(e){return 1==e.i?(c=[],t(e,Wk(Yk,b),2)):3!=e.i?(d=e.j,t(e,Ck(d,["databases"],{S:!0,mode:"readonly"},function(f){c.length=0;return Lk(f.objectStore("databases"),{},function(g){a(g.getValue())&&c.push(g.getValue());return g.continue()})}),3)):e.return(c)})}
function bl(a){return al(function(b){return"LogsDatabaseV2"===b.publicName&&void 0!==b.userIdentifier},a)}
function cl(a,b,c){return al(function(d){return c?void 0!==d.userIdentifier&&!a.includes(d.userIdentifier)&&c.includes(d.publicName):void 0!==d.userIdentifier&&!a.includes(d.userIdentifier)},b)}
function dl(a){var b,c;return w(function(d){if(1==d.i)return b=ak("YtIdbMeta hasAnyMeta other"),t(d,al(function(e){return void 0!==e.userIdentifier&&e.userIdentifier!==b},a),2);
...
wa(e,2);d={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return t(e,Zk(d,fl),4);case 4:return t(e,$k("yt-idb-test-do-not-use",fl),5);case 5:return e.return(!0);case 2:return ya(e),e.return(!1)}})}
function hl(){if(void 0!==el)return el;Sj=!0;return el=gl().then(function(a){Sj=!1;var b;if(null!=(b=Oj())&&b.i){var c;b={hasSucceededOnce:(null==(c=Pj())?void 0:c.hasSucceededOnce)||a};var d;null==(d=Oj())||d.set("LAST_RESULT_ENTRY_KEY",b,2592E3,!0)}return a})}
function il(){return z("ytglobal.idbToken_")||void 0}
function jl(){var a=il();return a?Promise.resolve(a):hl().then(function(b){(b=b?fl:void 0)&&y("ytglobal.idbToken_",b);return b})}
;var kl=0;function ll(a,b){kl||(kl=$e.O(function(){var c,d,e,f,g;return w(function(h){switch(h.i){case 1:return t(h,jl(),2);case 2:c=h.j;if(!c)return h.return();d=!0;wa(h,3);return t(h,cl(a,c,b),5);case 5:e=h.j;if(!e.length){d=!1;h.u(6);break}f=e[0];return t(h,Sk(f.actualName),7);case 7:return t(h,$k(f.actualName,c),6);case 6:xa(h,4);break;case 3:g=ya(h),Xj(g),d=!1;case 4:$e.V(kl),kl=0,d&&ll(a,b),h.i=0}})}))}
function ml(){var a;return w(function(b){return 1==b.i?t(b,jl(),2):(a=b.j)?b.return(dl(a)):b.return(!1)})}
new yd;function nl(a){if(!Zj())throw a=new jk("AUTH_INVALID",{dbName:a}),Xj(a),a;var b=ak();return{actualName:a+":"+b,publicName:a,userIdentifier:b}}
function ol(a,b,c,d){var e,f,g,h,k,m;return w(function(q){switch(q.i){case 1:return f=null!=(e=Error().stack)?e:"",t(q,jl(),2);case 2:g=q.j;if(!g)throw h=ok("openDbImpl",a,b),M("ytidb_async_stack_killswitch")||(h.stack=h.stack+"\n"+f.substring(f.indexOf("\n")+1)),Xj(h),h;bk(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:nl(a);wa(q,3);return t(q,Zk(k,g),5);case 5:return t(q,Rk(k.actualName,b,d),6);case 6:return q.return(q.j);case 3:return m=ya(q),wa(q,7),t(q,$k(k.actualName,g),9);case 9:xa(q,
8);break;case 7:ya(q);case 8:throw m;}})}
function pl(a,b,c){c=void 0===c?{}:c;return ol(a,b,!1,c)}
function ql(a,b,c){c=void 0===c?{}:c;return ol(a,b,!0,c)}
function rl(a,b){b=void 0===b?{}:b;var c,d;return w(function(e){if(1==e.i)return t(e,jl(),2);if(3!=e.i){c=e.j;if(!c)return e.return();bk(a);d=nl(a);return t(e,Sk(d.actualName,b),3)}return t(e,$k(d.actualName,c),0)})}
function sl(a,b,c){a=a.map(function(d){return w(function(e){return 1==e.i?t(e,Sk(d.actualName,b),2):t(e,$k(d.actualName,c),0)})});
return Promise.all(a).then(function(){})}
function tl(){var a=void 0===a?{}:a;var b,c;return w(function(d){if(1==d.i)return t(d,jl(),2);if(3!=d.i){b=d.j;if(!b)return d.return();bk("LogsDatabaseV2");return t(d,bl(b),3)}c=d.j;return t(d,sl(c,a,b),0)})}
function ul(a,b){b=void 0===b?{}:b;var c;return w(function(d){if(1==d.i)return t(d,jl(),2);if(3!=d.i){c=d.j;if(!c)return d.return();bk(a);return t(d,Sk(a,b),3)}return t(d,$k(a,c),0)})}
;function vl(a){this.i=!1;this.potentialEsfErrorCounter=this.j=0;this.handleError=function(){};
this.ra=function(){};
...
(!this.G||this.G("networkless_logging"))&&wl(this)}
function wl(a){a.A&&!a.xa&&(a.i=!0,a.La&&Math.random()<=a.Ka&&a.L.Qb(a.A),xl(a),a.K.I()&&a.Ba(),a.K.X(a.hb,a.Ba.bind(a)),a.K.X(a.gb,a.mb.bind(a)))}
l=vl.prototype;l.writeThenSend=function(a,b){var c=this;b=void 0===b?{}:b;if(this.A&&this.i){var d={url:a,options:b,timestamp:this.now(),status:"NEW",sendCount:0};this.L.set(d,this.A).then(function(e){d.id=e;c.K.I()&&yl(c,d)}).catch(function(e){yl(c,d);
zl(c,e)})}else this.ea(a,b)};
...
b.onError=function(g,h){return w(function(k){if(1==k.i)return t(k,d.L.set(e,d.A).catch(function(m){zl(d,m)}),2);
f(g,h);k.i=0})}}this.ea(a,b,e.skipRetry)}else this.L.set(e,this.A).catch(function(g){d.ea(a,b,e.skipRetry);
zl(d,g)})}else this.ea(a,b,this.G&&this.G("nwl_skip_retry")&&c)};
...
this.ea(d.url,d.options);this.L.set(d,this.A).then(function(g){d.id=g;e&&c.L.qa(d.id,c.A)}).catch(function(g){zl(c,g)})}else this.ea(a,b)};
l.Ba=function(){var a=this;if(!this.A)throw ok("throttleSend");this.j||(this.j=this.W.O(function(){var b;return w(function(c){if(1==c.i)return t(c,a.L.vb("NEW",a.A),2);if(3!=c.i)return b=c.j,b?t(c,yl(a,b),3):(a.mb(),c.return());a.j&&(a.j=0,a.Ba());c.i=0})},this.Jb))};
l.mb=function(){this.W.V(this.j);this.j=0};
function yl(a,b){var c,d;return w(function(e){switch(e.i){case 1:if(!a.A)throw c=ok("immediateSend"),c;if(void 0===b.id){e.u(2);break}return t(e,a.L.ac(b.id,a.A),3);case 3:(d=e.j)?b=d:a.ra(Error("The request cannot be found in the database."));case 2:if(Al(a,b,a.Fb)){e.u(4);break}a.ra(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.u(5);break}return t(e,a.L.qa(b.id,a.A),5);case 5:return e.return();case 4:b.skipRetry||(b=Bl(a,b));if(!b){e.u(0);break}if(!b.skipRetry||
void 0===b.id){e.u(8);break}return t(e,a.L.qa(b.id,a.A),8);case 8:a.ea(b.url,b.options,!!b.skipRetry),e.i=0}})}
function Bl(a,b){if(!a.A)throw ok("updateRequestHandlers");var c=b.options.onError?b.options.onError:function(){};
b.options.onError=function(e,f){var g,h,k;return w(function(m){switch(m.i){case 1:g=Cl(f);if(!(a.G&&a.G("nwl_consider_error_code")&&g||a.G&&!a.G("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.Ra)){m.u(2);break}if(!a.K.fa){m.u(3);break}return t(m,a.K.fa(),3);case 3:if(a.K.I()){m.u(2);break}c(e,f);if(!a.G||!a.G("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){m.u(6);break}return t(m,a.L.ib(b.id,a.A,!1),6);case 6:return m.return();case 2:if(a.G&&a.G("nwl_consider_error_code")&&
...
return b}
function Al(a,b,c){b=b.timestamp;return a.now()-b>=c?!1:!0}
function xl(a){if(!a.A)throw ok("retryQueuedRequests");a.L.vb("QUEUED",a.A).then(function(b){b&&!Al(a,b,a.Db)?a.W.O(function(){return w(function(c){if(1==c.i)return void 0===b.id?c.u(2):t(c,a.L.ib(b.id,a.A),2);xl(a);c.i=0})}):a.K.I()&&a.Ba()})}
function zl(a,b){a.Lb&&!a.K.I()?a.Lb(b):a.handleError(b)}
function Cl(a){var b;return(a=null==a?void 0:null==(b=a.error)?void 0:b.code)&&400<=a&&599>=a?!1:!0}
;function Dl(a,b){this.version=a;this.args=b}
;function El(a,b){this.topic=a;this.i=b}
El.prototype.toString=function(){return this.topic};var Fl=z("ytPubsub2Pubsub2Instance")||new L;L.prototype.subscribe=L.prototype.subscribe;L.prototype.unsubscribeByKey=L.prototype.va;L.prototype.publish=L.prototype.ka;L.prototype.clear=L.prototype.clear;y("ytPubsub2Pubsub2Instance",Fl);var Gl=z("ytPubsub2Pubsub2SubscribedKeys")||{};y("ytPubsub2Pubsub2SubscribedKeys",Gl);var Hl=z("ytPubsub2Pubsub2TopicToKeys")||{};y("ytPubsub2Pubsub2TopicToKeys",Hl);var Il=z("ytPubsub2Pubsub2IsAsync")||{};y("ytPubsub2Pubsub2IsAsync",Il);
y("ytPubsub2Pubsub2SkipSubKey",null);function Jl(a,b){var c=Kl();c&&c.publish.call(c,a.toString(),a,b)}
function Ll(a){var b=Ml,c=Kl();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=z("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(Gl[d])try{if(f&&b instanceof El&&b!=e)try{var h=b.i,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!h.ja){var m=new h;h.ja=m.version}var q=h.ja}catch(H){}if(!q||k.version!=q)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{q=Reflect;var u=q.construct;
var B=k.args,v=B.length;if(0<v){var E=Array(v);for(k=0;k<v;k++)E[k]=B[k];var F=E}else F=[];f=u.call(q,h,F)}catch(H){throw H.message="yt.pubsub2.Data.deserialize(): "+H.message,H;}}catch(H){throw H.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+H.message,H;}a.call(window,f)}catch(H){Th(H)}},Il[b.toString()]?z("yt.scheduler.instance")?$e.O(g):mi(g,0):g())});
Gl[d]=!0;Hl[b.toString()]||(Hl[b.toString()]=[]);Hl[b.toString()].push(d);return d}
function Nl(){var a=Ol,b=Ll(function(c){a.apply(void 0,arguments);Pl(b)});
return b}
function Pl(a){var b=Kl();b&&("number"===typeof a&&(a=[a]),eb(a,function(c){b.unsubscribeByKey(c);delete Gl[c]}))}
function Kl(){return z("ytPubsub2Pubsub2Instance")}
;function Ql(a,b){Uk.call(this,a,b);this.options=b;bk(a)}
r(Ql,Uk);function Rl(a,b){var c;return function(){c||(c=new Ql(a,b));return c}}
Ql.prototype.l=function(a,b,c){c=void 0===c?{}:c;return(this.options.jb?ql:pl)(a,b,Object.assign({},c))};
Ql.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.jb?ul:rl)(this.name,a)};
function Sl(a,b){return Rl(a,b)}
;var Tl;
function Ul(){if(Tl)return Tl();var a={};Tl=Sl("LogsDatabaseV2",{ya:(a.LogsRequestsStore={Wa:2},a),jb:!1,upgrade:function(b,c,d){c(2)&&Dk(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0});c(3);c(5)&&(d=d.objectStore("LogsRequestsStore"),d.i.indexNames.contains("newRequest")&&d.i.deleteIndex("newRequest"),d.i.createIndex("newRequestV2",["status","interface","timestamp"],{unique:!1}));c(7)&&b.i.objectStoreNames.contains("sapisid")&&b.i.deleteObjectStore("sapisid");c(9)&&b.i.objectStoreNames.contains("SWHealthLog")&&b.i.deleteObjectStore("SWHealthLog")},
version:9});return Tl()}
;function Vl(a){return Wk(Ul(),a)}
function Wl(a,b){var c,d,e,f;return w(function(g){if(1==g.i)return c={startTime:P(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},t(g,Vl(b),2);if(3!=g.i)return d=g.j,e=Object.assign({},a,{options:JSON.parse(JSON.stringify(a.options)),interface:A("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),t(g,Fk(d,e),3);f=g.j;c.Bc=P();Xl(c);return g.return(f)})}
function Yl(a,b){var c,d,e,f,g,h,k;return w(function(m){if(1==m.i)return c={startTime:P(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},t(m,Vl(b),2);if(3!=m.i)return d=m.j,e=A("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=[a,e,0],g=[a,e,P()],h=IDBKeyRange.bound(f,g),k=void 0,t(m,Ck(d,["LogsRequestsStore"],{mode:"readwrite",S:!0},function(q){return Ok(q.objectStore("LogsRequestsStore").index("newRequestV2"),{query:h,direction:"prev"},function(u){u.getValue()&&(k=u.getValue(),"NEW"===a&&(k.status="QUEUED",
u.update(k)))})}),3);
c.Bc=P();Xl(c);return m.return(k)})}
function Zl(a,b){var c;return w(function(d){if(1==d.i)return t(d,Vl(b),2);c=d.j;return d.return(Ck(c,["LogsRequestsStore"],{mode:"readwrite",S:!0},function(e){var f=e.objectStore("LogsRequestsStore");return f.get(a).then(function(g){if(g)return g.status="QUEUED",zk(f.i.put(g,void 0)).then(function(){return g})})}))})}
function $l(a,b,c){c=void 0===c?!0:c;var d;return w(function(e){if(1==e.i)return t(e,Vl(b),2);d=e.j;return e.return(Ck(d,["LogsRequestsStore"],{mode:"readwrite",S:!0},function(f){var g=f.objectStore("LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",c&&(h.sendCount+=1),zk(g.i.put(h,void 0)).then(function(){return h})):sk.resolve(void 0)})}))})}
function am(a,b){var c;return w(function(d){if(1==d.i)return t(d,Vl(b),2);c=d.j;return d.return(c.delete("LogsRequestsStore",a))})}
function bm(a){var b,c;return w(function(d){if(1==d.i)return t(d,Vl(a),2);b=d.j;c=P()-2592E6;return t(d,Ck(b,["LogsRequestsStore"],{mode:"readwrite",S:!0},function(e){return Lk(e.objectStore("LogsRequestsStore"),{},function(f){if(f.getValue().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
function cm(){return w(function(a){return t(a,tl(),0)})}
function Xl(a){M("nwl_csi_killswitch")||.01>=Math.random()&&Jl("nwl_transaction_latency_payload",a)}
;var dm={},em=Sl("ServiceWorkerLogsDatabase",{ya:(dm.SWHealthLog={Wa:1},dm),jb:!0,upgrade:function(a,b){b(1)&&Dk(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).i.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
version:1});function fm(a){return Wk(em(),a)}
function gm(a){var b,c;return w(function(d){if(1==d.i)return t(d,fm(a),2);b=d.j;c=P()-2592E6;return t(d,Ck(b,["SWHealthLog"],{mode:"readwrite",S:!0},function(e){return Lk(e.objectStore("SWHealthLog"),{},function(f){if(f.getValue().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
function hm(a){var b;return w(function(c){if(1==c.i)return t(c,fm(a),2);b=c.j;return t(c,b.clear("SWHealthLog"),0)})}
;var im={},jm=0;
function km(a){var b=void 0===b?"":b;var c=void 0===c?!1:c;if(a)if(b)Ri(a,void 0,"POST",b);else if(A("USE_NET_AJAX_FOR_PING_TRANSPORT",!1))Ri(a,void 0,"GET","",void 0,void 0,c);else{b:{try{var d=new ab({url:a});if(d.l&&d.j||d.m){var e=ac(bc(5,a)),f;if(!(f=!e||!e.endsWith("/aclk"))){var g=a.search(ic),h=hc(a,0,"ri",g);if(0>h)var k=null;else{var m=a.indexOf("&",h);if(0>m||m>g)m=g;k=decodeURIComponent(a.slice(h+3,-1!==m?m:0).replace(/\+/g," "))}f="1"!==k}var q=!f;break b}}catch(B){}q=!1}if(q){b:{try{if(window.navigator&&
window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")){var u=!0;break b}}catch(B){}u=!1}b=u?!0:!1}else b=!1;b||lm(a)}}
function lm(a){var b=new Image,c=""+jm++;im[c]=b;b.onload=b.onerror=function(){delete im[c]};
b.src=a}
;function mm(){this.i=new Map;this.j=!1}
function nm(){if(!mm.i){var a=z("yt.networkRequestMonitor.instance")||new mm;y("yt.networkRequestMonitor.instance",a);mm.i=a}return mm.i}
mm.prototype.requestComplete=function(a,b){b&&(this.j=!0);a=this.removeParams(a);this.i.get(a)||this.i.set(a,b)};
mm.prototype.isEndpointCFR=function(a){a=this.removeParams(a);return(a=this.i.get(a))?!1:!1===a&&this.j?!0:null};
mm.prototype.removeParams=function(a){return a.split("?")[0]};
mm.prototype.removeParams=mm.prototype.removeParams;mm.prototype.isEndpointCFR=mm.prototype.isEndpointCFR;mm.prototype.requestComplete=mm.prototype.requestComplete;mm.getInstance=nm;var om;function pm(){om||(om=new xj("yt.offline"));return om}
function qm(a){if(M("offline_error_handling")){var b=pm().get("errors",!0)||{};b[a.message]={name:a.name,stack:a.stack};a.level&&(b[a.message].level=a.level);pm().set("errors",b,2592E3,!0)}}
function rm(){if(M("offline_error_handling")){var a=pm().get("errors",!0);if(a){for(var b in a)if(a[b]){var c=new Q(b,"sent via offline_errors");c.name=a[b].name;c.stack=a[b].stack;c.level=a[b].level;Th(c)}pm().set("errors",{},2592E3,!0)}}}
;var sm=Nh("network_polling_interval",3E4);function tm(){Te.call(this);var a=this;this.U=0;this.B=this.o=!1;this.l=this.ab();M("use_shared_nsm")?(this.j=Ze(),M("use_shared_nsm_and_keep_yt_online_updated")&&(this.j.X("networkstatus-online",function(){a.l=!0;a.B&&rm()}),this.j.X("networkstatus-offline",function(){a.l=!1}))):(um(this),vm(this))}
r(tm,Te);function wm(){if(!tm.i){var a=z("yt.networkStatusManager.instance")||new tm;y("yt.networkStatusManager.instance",a);tm.i=a}return tm.i}
l=tm.prototype;l.I=function(){if(M("use_shared_nsm")&&this.j){var a;return null==(a=this.j)?void 0:a.I()}return this.l};
l.da=function(a){if(M("use_shared_nsm")&&this.j){var b;null!=(b=this.j)&&(b.j=a)}else a!==this.l&&(this.l=a)};
l.cc=function(a){!M("use_shared_nsm")&&(this.o=!0,void 0===a?0:a)&&(this.U||xm(this))};
...
function vm(a){window.addEventListener("online",function(){return w(function(b){if(1==b.i)return t(b,a.fa(),2);a.B&&rm();b.i=0})})}
function um(a){window.addEventListener("offline",function(){return w(function(b){return t(b,a.fa(),0)})})}
function xm(a){a.U=Gj(function(){return w(function(b){if(1==b.i)return a.l?a.ab()||!a.o?b.u(3):t(b,a.fa(),3):t(b,a.fa(),3);xm(a);b.i=0})},sm)}
l.fa=function(a){var b=this;if(M("use_shared_nsm")&&this.j){var c=Xe(this.j,a);c.then(function(d){M("use_cfr_monitor")&&nm().requestComplete("generate_204",d)});
...
signal:g}),5);case 5:h=!0;case 3:za(k);M("use_cfr_monitor")&&nm().requestComplete("generate_204",h);b.v=void 0;b.N&&$e.V(b.N);h!==b.l&&(b.l=h,b.l&&b.o?Ue(b,"ytnetworkstatus-online"):b.o&&Ue(b,"ytnetworkstatus-offline"));d(h);Aa(k);break;case 2:ya(k),h=!1,k.u(3)}})})};
tm.prototype.sendNetworkCheckRequest=tm.prototype.fa;tm.prototype.listen=tm.prototype.X;tm.prototype.enableErrorFlushing=tm.prototype.Tb;tm.prototype.getWindowStatus=tm.prototype.ab;tm.prototype.monitorNetworkStatusChange=tm.prototype.cc;tm.prototype.networkStatusHint=tm.prototype.da;tm.prototype.isNetworkAvailable=tm.prototype.I;tm.getInstance=wm;function ym(a){a=void 0===a?{}:a;Te.call(this);var b=this;this.l=this.N=0;this.o="ytnetworkstatus-offline";this.v="ytnetworkstatus-online";M("use_shared_nsm")&&(this.o="networkstatus-offline",this.v="networkstatus-online");this.j=wm();var c=z("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.j);c&&c(a.sb);a.Ab&&(c=z("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j))&&c();if(c=z("yt.networkStatusManager.instance.listen").bind(this.j))a.Ta?(this.Ta=a.Ta,c(this.v,
function(){zm(b,"publicytnetworkstatus-online")}),c(this.o,function(){zm(b,"publicytnetworkstatus-offline")})):(c(this.v,function(){Ue(b,"publicytnetworkstatus-online")}),c(this.o,function(){Ue(b,"publicytnetworkstatus-offline")}))}
r(ym,Te);ym.prototype.I=function(){var a=z("yt.networkStatusManager.instance.isNetworkAvailable");return a?a.bind(this.j)():!0};
ym.prototype.da=function(a){var b=z("yt.networkStatusManager.instance.networkStatusHint").bind(this.j);b&&b(a)};
ym.prototype.fa=function(a){var b=this,c;return w(function(d){c=z("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.j);return M("skip_network_check_if_cfr")&&nm().isEndpointCFR("generate_204")?d.return(new Promise(function(e){var f;b.da((null==(f=window.navigator)?void 0:f.onLine)||!0);e(b.I())})):c?d.return(c(a)):d.return(!0)})};
function zm(a,b){a.Ta?a.l?($e.V(a.N),a.N=$e.O(function(){a.B!==b&&(Ue(a,b),a.B=b,a.l=P())},a.Ta-(P()-a.l))):(Ue(a,b),a.B=b,a.l=P()):Ue(a,b)}
;var Am;function Bm(){vl.call(this,{L:{Qb:bm,qa:am,vb:Yl,ac:Zl,ib:$l,set:Wl},K:Cm(),handleError:Th,ra:Uh,ea:Dm,now:P,Lb:qm,W:Lj(),hb:"publicytnetworkstatus-online",gb:"publicytnetworkstatus-offline",La:!0,Ka:.1,Ra:Nh("potential_esf_error_limit",10),G:M,xa:!(Zj()&&Em())});this.l=new yd;M("networkless_immediately_drop_all_requests")&&cm();ul("LogsDatabaseV2")}
r(Bm,vl);function Fm(){var a=z("yt.networklessRequestController.instance");a||(a=new Bm,y("yt.networklessRequestController.instance",a),M("networkless_logging")&&jl().then(function(b){a.A=b;wl(a);a.l.resolve();a.La&&Math.random()<=a.Ka&&a.A&&gm(a.A);M("networkless_immediately_drop_sw_health_store")&&Gm(a)}));
return a}
Bm.prototype.writeThenSend=function(a,b){b||(b={});Zj()||(this.i=!1);vl.prototype.writeThenSend.call(this,a,b)};
Bm.prototype.sendThenWrite=function(a,b,c){b||(b={});Zj()||(this.i=!1);vl.prototype.sendThenWrite.call(this,a,b,c)};
Bm.prototype.sendAndWrite=function(a,b){b||(b={});Zj()||(this.i=!1);vl.prototype.sendAndWrite.call(this,a,b)};
Bm.prototype.awaitInitialization=function(){return this.l.promise};
function Gm(a){var b;w(function(c){if(!a.A)throw b=ok("clearSWHealthLogsDb"),b;return c.return(hm(a.A).catch(function(d){a.handleError(d)}))})}
function Dm(a,b,c){M("use_cfr_monitor")&&Hm(a,b);var d;if(null==(d=b.postParams)?0:d.requestTimeMs)b.postParams.requestTimeMs=Math.round(P());c&&0===Object.keys(b).length?km(a):Oi(a,b)}
function Cm(){Am||(Am=new ym({Ab:!0,sb:!0}));return Am}
function Hm(a,b){var c=b.onError?b.onError:function(){};
b.onError=function(e,f){nm().requestComplete(a,!1);c(e,f)};
var d=b.onSuccess?b.onSuccess:function(){};
b.onSuccess=function(e,f){nm().requestComplete(a,!0);d(e,f)}}
function Em(){return M("embeds_web_nwl_disable_nocookie")?"www.youtube-nocookie.com"!==cc(document.location.toString()):!0}
;var Im=!1,Jm=0,Km=0,Lm,Mm=x.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:Im,potentialEsfErrorCounter:Km};y("ytNetworklessLoggingInitializationOptions",Mm);
function Nm(){var a;w(function(b){switch(b.i){case 1:return t(b,jl(),2);case 2:a=b.j;if(!a||!Zj()&&!M("nwl_init_require_datasync_id_killswitch")||!Em()){b.u(0);break}Im=!0;Mm.isNwlInitialized=Im;if(!M("use_new_nwl_initialization")){b.u(4);break}return t(b,Fm().awaitInitialization(),5);case 5:return b.return();case 4:return t(b,ul("LogsDatabaseV2"),6);case 6:if(!(.1>=Math.random())){b.u(7);break}return t(b,bm(a),8);case 8:return t(b,gm(a),7);case 7:Om();Pm().I()&&Qm();Pm().X("publicytnetworkstatus-online",
Qm);Pm().X("publicytnetworkstatus-offline",Rm);if(!M("networkless_immediately_drop_sw_health_store")){b.u(10);break}return t(b,Sm(),10);case 10:if(M("networkless_immediately_drop_all_requests"))return t(b,cm(),0);b.u(0)}})}
function Tm(a,b){function c(d){var e=Pm().I();if(!Um()||!d||e&&M("vss_networkless_bypass_write"))Vm(a,b);else{var f={url:a,options:b,timestamp:P(),status:"NEW",sendCount:0};Wl(f,d).then(function(g){f.id=g;Pm().I()&&Wm(f)}).catch(function(g){Wm(f);
Pm().I()?Th(g):qm(g)})}}
b=void 0===b?{}:b;M("skip_is_supported_killswitch")?jl().then(function(d){c(d)}):c(il())}
function Xm(a,b){function c(d){if(Um()&&d){var e={url:a,options:b,timestamp:P(),status:"NEW",sendCount:0},f=!1,g=b.onSuccess?b.onSuccess:function(){};
e.options.onSuccess=function(k,m){M("use_cfr_monitor")&&nm().requestComplete(e.url,!0);void 0!==e.id?am(e.id,d):f=!0;M("vss_network_hint")&&Pm().da(!0);g(k,m)};
if(M("use_cfr_monitor")){var h=b.onError?b.onError:function(){};
e.options.onError=function(k,m){nm().requestComplete(e.url,!1);h(k,m)}}Vm(e.url,e.options);
Wl(e,d).then(function(k){e.id=k;f&&am(e.id,d)}).catch(function(k){Pm().I()?Th(k):qm(k)})}else Vm(a,b)}
b=void 0===b?{}:b;M("skip_is_supported_killswitch")?jl().then(function(d){c(d)}):c(il())}
function Qm(){var a=il();if(!a)throw ok("throttleSend");Jm||(Jm=$e.O(function(){var b;return w(function(c){if(1==c.i)return t(c,Yl("NEW",a),2);if(3!=c.i)return b=c.j,b?t(c,Wm(b),3):(Rm(),c.return());Jm&&(Jm=0,Qm());c.i=0})},100))}
function Rm(){$e.V(Jm);Jm=0}
function Wm(a){var b,c,d;return w(function(e){switch(e.i){case 1:b=il();if(!b)throw c=ok("immediateSend"),c;if(void 0===a.id){e.u(2);break}return t(e,Zl(a.id,b),3);case 3:(d=e.j)?a=d:Uh(Error("The request cannot be found in the database."));case 2:if(Ym(a,2592E6)){e.u(4);break}Uh(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){e.u(5);break}return t(e,am(a.id,b),5);case 5:return e.return();case 4:a.skipRetry||(a=Zm(a));var f=a,g,h;if(null==f?0:null==(g=f.options)?
0:null==(h=g.postParams)?0:h.requestTimeMs)f.options.postParams.requestTimeMs=Math.round(P());a=f;if(!a){e.u(0);break}if(!a.skipRetry||void 0===a.id){e.u(8);break}return t(e,am(a.id,b),8);case 8:Vm(a.url,a.options,!!a.skipRetry),e.i=0}})}
function Zm(a){var b=il();if(!b)throw ok("updateRequestHandlers");var c=a.options.onError?a.options.onError:function(){};
a.options.onError=function(e,f){var g,h,k;return w(function(m){switch(m.i){case 1:M("use_cfr_monitor")&&nm().requestComplete(a.url,!1);g=Cl(f);if(!(M("nwl_consider_error_code")&&g||!M("nwl_consider_error_code")&&$m()<=Nh("potential_esf_error_limit",10))){m.u(2);break}if(M("skip_checking_network_on_cfr_failure")&&(!M("skip_checking_network_on_cfr_failure")||nm().isEndpointCFR(a.url))){m.u(3);break}return t(m,Pm().fa(),3);case 3:if(Pm().I()){m.u(2);break}c(e,f);if(!M("nwl_consider_error_code")||void 0===
(null==(h=a)?void 0:h.id)){m.u(6);break}return t(m,$l(a.id,b,!1),6);case 6:return m.return();case 2:if(M("nwl_consider_error_code")&&!g&&$m()>Nh("potential_esf_error_limit",10))return m.return();z("ytNetworklessLoggingInitializationOptions")&&Mm.potentialEsfErrorCounter++;Km++;if(void 0===(null==(k=a)?void 0:k.id)){m.u(8);break}return 1>a.sendCount?t(m,$l(a.id,b),12):t(m,am(a.id,b),8);case 12:$e.O(function(){Pm().I()&&Qm()},5E3);
case 8:c(e,f),m.i=0}})};
var d=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(e,f){var g;return w(function(h){if(1==h.i)return M("use_cfr_monitor")&&nm().requestComplete(a.url,!0),void 0===(null==(g=a)?void 0:g.id)?h.u(2):t(h,am(a.id,b),2);M("vss_network_hint")&&Pm().da(!0);d(e,f);h.i=0})};
return a}
function Ym(a,b){a=a.timestamp;return P()-a>=b?!1:!0}
function Om(){var a=il();if(!a)throw ok("retryQueuedRequests");Yl("QUEUED",a).then(function(b){b&&!Ym(b,12E4)?$e.O(function(){return w(function(c){if(1==c.i)return void 0===b.id?c.u(2):t(c,$l(b.id,a),2);Om();c.i=0})}):Pm().I()&&Qm()})}
function Sm(){var a,b;return w(function(c){a=il();if(!a)throw b=ok("clearSWHealthLogsDb"),b;return c.return(hm(a).catch(function(d){Th(d)}))})}
function Pm(){if(M("use_new_nwl"))return Cm();Lm||(Lm=new ym({Ab:!0,sb:!0}));return Lm}
function Vm(a,b,c){c&&0===Object.keys(b).length?km(a):Oi(a,b)}
function Um(){return z("ytNetworklessLoggingInitializationOptions")?Mm.isNwlInitialized:Im}
function $m(){return z("ytNetworklessLoggingInitializationOptions")?Mm.potentialEsfErrorCounter:Km}
;function an(a){var b=this;this.config_=null;a?this.config_=a:nj()&&(this.config_=oj());Gj(function(){Dj(b)},5E3)}
an.prototype.isReady=function(){!this.config_&&nj()&&(this.config_=oj());return!!this.config_};
...
c.onFetchSuccess=function(O,S){Cj(F);R(O,S)}}try{E&&d.retry&&!d.Bb.bypassNetworkless?(g.method="POST",d.Bb.writeThenSend?M("use_new_nwl_wts")?Fm().writeThenSend(v,g):Tm(v,g):M("use_new_nwl_saw")?Fm().sendAndWrite(v,g):Xm(v,g)):(g.method="POST",g.postParams||(g.postParams={}),Oi(v,g))}catch(O){if("InvalidAccessError"==O.name)F&&(Cj(F),F=0),Uh(Error("An extension is blocking network request."));
...
timeout:d.timeout,withCredentials:!0};g.headers["Content-Type"]||(g.headers["Content-Type"]="application/json");var h="";(f=a.config_.Xb)&&(h=f);var k=a.config_.Zb||!1,m=vj(k,h,d);Object.assign(g.headers,m);(f=g.headers.Authorization)&&!h&&(g.headers["x-origin"]=window.location.origin);var q="/youtubei/"+a.config_.innertubeApiVersion+"/"+b,u={alt:"json"},B=a.config_.Yb&&f;B=B&&f.startsWith("Bearer");B||(u.key=a.config_.innertubeApiKey);var v=fi(""+h+q,u||{},!0);M("use_new_nwl")&&Fm().i||!M("use_new_nwl")&&
Um()?hl().then(function(E){e(E)}):e(!1)}
;var bn={appSettingsCaptured:!0,visualElementAttached:!0,visualElementGestured:!0,visualElementHidden:!0,visualElementShown:!0,flowEvent:!0,visualElementStateChanged:!0,playbackAssociated:!0,youThere:!0,accountStateChangeSignedIn:!0,accountStateChangeSignedOut:!0},cn={latencyActionBaselined:!0,latencyActionInfo:!0,latencyActionTicked:!0,bedrockRepetitiveActionTimed:!0,adsClientStateChange:!0,streamzIncremented:!0,mdxDialAdditionalDataUpdateEvent:!0,tvhtml5WatchKeyEvent:!0,tvhtml5VideoSeek:!0,tokenRefreshEvent:!0,
adNotify:!0,adNotifyFilled:!0,tvhtml5LaunchUrlComponentChanged:!0,bedrockResourceConsumptionSnapshot:!0,deviceStartupMetrics:!0,mdxSignIn:!0,tvhtml5KeyboardLogging:!0,tvhtml5StartupSoundEvent:!0,tvhtml5LiveChatStatus:!0,tvhtml5DeviceStorageStatus:!0,tvhtml5LocalStorage:!0,directSignInEvent:!0,finalPayload:!0,tvhtml5SearchCompleted:!0,tvhtml5KeyboardPerformance:!0,adNotifyFailure:!0,latencyActionSpan:!0,tvhtml5AccountDialogOpened:!0,tvhtml5ApiTest:!0};var dn=0,en=uc?"webkit":tc?"moz":rc?"ms":qc?"o":"";y("ytDomDomGetNextId",z("ytDomDomGetNextId")||function(){return++dn});var fn={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
function gn(a){this.type="";this.state=this.source=this.data=this.currentTarget=this.relatedTarget=this.target=null;this.charCode=this.keyCode=0;this.metaKey=this.shiftKey=this.ctrlKey=this.altKey=!1;this.rotation=this.clientY=this.clientX=0;this.scale=1;this.changedTouches=this.touches=null;try{if(a=a||window.event){this.event=a;for(var b in a)b in fn||(this[b]=a[b]);this.scale=a.scale;this.rotation=a.rotation;var c=a.target||a.srcElement;c&&3==c.nodeType&&(c=c.parentNode);this.target=c;var d=a.relatedTarget;
...
function hn(a){if(document.body&&document.documentElement){var b=document.body.scrollTop+document.documentElement.scrollTop;a.i=a.clientX+(document.body.scrollLeft+document.documentElement.scrollLeft);a.j=a.clientY+b}}
gn.prototype.preventDefault=function(){this.event&&(this.event.returnValue=!1,this.event.preventDefault&&this.event.preventDefault())};
gn.prototype.stopPropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopPropagation&&this.event.stopPropagation())};
gn.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var nb=x.ytEventsEventsListeners||{};y("ytEventsEventsListeners",nb);var jn=x.ytEventsEventsCounter||{count:0};y("ytEventsEventsCounter",jn);
...
var ln=cb(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function mn(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=kn(a,b,c,d);if(e)return e;e=++jn.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new gn(h);if(!Ld(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new gn(h);
h.currentTarget=a;return c.call(a,h)};
g=Sh(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),ln()||"boolean"===typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);nb[e]=[a,b,c,g,d];return e}
function nn(a){a&&("string"==typeof a&&(a=[a]),eb(a,function(b){if(b in nb){var c=nb[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?ln()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete nb[b]}}))}
;var on=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function pn(a){this.M=a;this.j=null;this.o=0;this.B=null;this.v=0;this.l=[];for(a=0;4>a;a++)this.l.push(0);this.m=0;this.U=mn(window,"mousemove",Wa(this.Z,this));a=Wa(this.N,this);"function"===typeof a&&(a=Sh(a));this.ga=window.setInterval(a,25)}
Ya(pn,K);pn.prototype.Z=function(a){void 0===a.i&&hn(a);var b=a.i;void 0===a.j&&hn(a);this.j=new Hd(b,a.j)};
pn.prototype.N=function(){if(this.j){var a=on();if(0!=this.o){var b=this.B,c=this.j,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.o);this.l[this.m]=.5<Math.abs((d-this.v)/this.v)?1:0;for(c=b=0;4>c;c++)b+=this.l[c]||0;3<=b&&this.M();this.v=d}this.o=a;this.B=this.j;this.m=(this.m+1)%4}};
pn.prototype.J=function(){window.clearInterval(this.ga);nn(this.U)};var qn={};
function rn(a){var b=void 0===a?{}:a;a=void 0===b.fc?!1:b.fc;b=void 0===b.Ub?!0:b.Ub;if(null==z("_lact",window)){var c=parseInt(A("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&sn();mn(document,"keydown",sn);mn(document,"keyup",sn);mn(document,"mousedown",sn);mn(document,"mouseup",sn);a?mn(window,"touchmove",function(){tn("touchmove",200)},{passive:!0}):(mn(window,"resize",function(){tn("resize",200)}),b&&mn(window,"scroll",function(){tn("scroll",200)}));
new pn(function(){tn("mouse",100)});
mn(document,"touchstart",sn,{passive:!0});mn(document,"touchend",sn,{passive:!0})}}
function tn(a,b){qn[a]||(qn[a]=!0,$e.O(function(){sn();qn[a]=!1},b))}
function sn(){null==z("_lact",window)&&rn();var a=Date.now();y("_lact",a,window);-1==z("_fact",window)&&y("_fact",a,window);(a=z("ytglobal.ytUtilActivityCallback_"))&&a()}
function un(){var a=z("_lact",window);return null==a?-1:Math.max(Date.now()-a,0)}
;var vn=x.ytPubsubPubsubInstance||new L,wn=x.ytPubsubPubsubSubscribedKeys||{},xn=x.ytPubsubPubsubTopicToKeys||{},yn=x.ytPubsubPubsubIsSynchronous||{};function zn(a,b){var c=An();if(c&&b){var d=c.subscribe(a,function(){var e=arguments;var f=function(){wn[d]&&b.apply&&"function"==typeof b.apply&&b.apply(window,e)};
try{yn[a]?f():mi(f,0)}catch(g){Th(g)}},void 0);
wn[d]=!0;xn[a]||(xn[a]=[]);xn[a].push(d);return d}return 0}
function Bn(a){var b=An();b&&("number"===typeof a?a=[a]:"string"===typeof a&&(a=[parseInt(a,10)]),eb(a,function(c){b.unsubscribeByKey(c);delete wn[c]}))}
function Cn(a,b){var c=An();c&&c.publish.apply(c,arguments)}
function Dn(a){var b=An();if(b)if(b.clear(a),a)Un(a);else for(var c in xn)Un(c)}
function An(){return x.ytPubsubPubsubInstance}
function Un(a){xn[a]&&(a=xn[a],eb(a,function(b){wn[b]&&delete wn[b]}),a.length=0)}
L.prototype.subscribe=L.prototype.subscribe;L.prototype.unsubscribeByKey=L.prototype.va;L.prototype.publish=L.prototype.ka;L.prototype.clear=L.prototype.clear;y("ytPubsubPubsubInstance",vn);y("ytPubsubPubsubTopicToKeys",xn);y("ytPubsubPubsubIsSynchronous",yn);y("ytPubsubPubsubSubscribedKeys",wn);var to=Nh("initial_gel_batch_timeout",2E3),uo=Math.pow(2,16)-1,vo=void 0;function wo(){this.l=this.i=this.j=0}
var xo=new wo,yo=new wo,zo=!0,Ao=x.ytLoggingTransportGELQueue_||new Map;y("ytLoggingTransportGELQueue_",Ao);var Bo=x.ytLoggingTransportGELProtoQueue_||new Map;y("ytLoggingTransportGELProtoQueue_",Bo);var Co=x.ytLoggingTransportTokensToCttTargetIds_||{};y("ytLoggingTransportTokensToCttTargetIds_",Co);var Do=x.ytLoggingTransportTokensToJspbCttTargetIds_||{};y("ytLoggingTransportTokensToJspbCttTargetIds_",Do);
function Eo(a,b){if("log_event"===a.endpoint){var c=Fo(a),d=Ao.get(c)||[];Ao.set(c,d);d.push(a.payload);Go(b,d,c)}}
function Ho(a,b){if("log_event"===a.endpoint){var c=Fo(a,!0),d=Bo.get(c)||[];Bo.set(c,d);a=a.payload.toJSON();d.push(a);Go(b,d,c,!0)}}
function Go(a,b,c,d){d=void 0===d?!1:d;a&&(vo=new a);a=Nh("tvhtml5_logging_max_batch")||Nh("web_logging_max_batch")||100;var e=P(),f=d?yo.l:xo.l;b.length>=a?Io({writeThenSend:!0},M("flush_only_full_queue")?c:void 0,d):10<=e-f&&(Jo(d),d?yo.l=e:xo.l=e)}
function Ko(a,b){if("log_event"===a.endpoint){var c=Fo(a),d=new Map;d.set(c,[a.payload]);b&&(vo=new b);return new Tf(function(e){vo&&vo.isReady()?Lo(d,e,{bypassNetworkless:!0},!0):e()})}}
function Mo(a,b){if("log_event"===a.endpoint){var c=Fo(a,!0),d=new Map;d.set(c,[a.payload.toJSON()]);b&&(vo=new b);return new Tf(function(e){vo&&vo.isReady()?No(d,e,{bypassNetworkless:!0},!0):e()})}}
function Fo(a,b){var c="";if(a.wa)c="visitorOnlyApprovedKey";else if(a.cttAuthInfo){if(void 0===b?0:b){b=a.cttAuthInfo.token;c=a.cttAuthInfo;var d=new Bh;c.videoId?d.setVideoId(c.videoId):c.playlistId&&kd(d,2,Ch,c.playlistId);Do[b]=d}else b=a.cttAuthInfo,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),Co[a.cttAuthInfo.token]=c;c=a.cttAuthInfo.token}return c}
function Io(a,b,c){a=void 0===a?{}:a;c=void 0===c?!1:c;new Tf(function(d){c?(ni(yo.j),ni(yo.i),yo.i=0):(ni(xo.j),ni(xo.i),xo.i=0);if(vo&&vo.isReady())if(void 0!==b)if(c){var e=new Map,f=Bo.get(b)||[];e.set(b,f);No(e,d,a);Bo.delete(b)}else e=new Map,f=Ao.get(b)||[],e.set(b,f),Lo(e,d,a),Ao.delete(b);else c?(No(Bo,d,a),Bo.clear()):(Lo(Ao,d,a),Ao.clear());else Jo(c),d()})}
function Jo(a){a=void 0===a?!1:a;if(M("web_gel_timeout_cap")&&(!a&&!xo.i||a&&!yo.i)){var b=mi(function(){Io({writeThenSend:!0},void 0,a)},6E4);
a?yo.i=b:xo.i=b}ni(a?yo.j:xo.j);b=A("LOGGING_BATCH_TIMEOUT",Nh("web_gel_debounce_ms",1E4));M("shorten_initial_gel_batch_timeout")&&zo&&(b=to);b=mi(function(){Io({writeThenSend:!0},void 0,a)},b);
a?yo.j=b:xo.j=b}
function Lo(a,b,c,d){var e=vo;c=void 0===c?{}:c;var f=Math.round(P()),g=a.size;a=p(a);for(var h=a.next();!h.done;h=a.next()){var k=p(h.value);h=k.next().value;var m=k=k.next().value;k=vb({context:pj(e.config_||oj())});k.events=m;(m=Co[h])&&Oo(k,h,m);delete Co[h];h="visitorOnlyApprovedKey"===h;Po(k,f,h);Qo(c);Ej(e,"log_event",k,Ro(c,h,function(){g--;g||b()},function(){g--;
g||b()},d));
zo=!1}}
function No(a,b,c,d){var e=vo;c=void 0===c?{}:c;var f=Math.round(P()),g=a.size;a=p(a);for(var h=a.next();!h.done;h=a.next()){var k=p(h.value);h=k.next().value;var m=k=k.next().value;k=new Dh;var q=uj(e.config_||oj());I(k,1,q);m=So(m);for(q=0;q<m.length;q++)pd(k,3,xh,m[q]);(m=Do[h])&&To(k,h,m);delete Do[h];h="visitorOnlyApprovedKey"===h;Uo(k,f,h);Qo(c);a:{Xc=!0;try{var u=JSON.stringify(k.toJSON(),ud);break a}finally{Xc=!1}u=void 0}k=u;h=Ro(c,h,function(){g--;g||b()},function(){g--;
g||b()},d);
h.headers={"Content-Type":"application/json+protobuf"};h.postBodyFormat="JSPB";h.postBody=k;Ej(e,"log_event","",h);zo=!1}}
function Qo(a){M("always_send_and_write")&&(a.writeThenSend=!1)}
function Ro(a,b,c,d,e){return{retry:!0,onSuccess:c,onError:d,Bb:a,wa:b,Yo:!!e,headers:{},postBodyFormat:"",postBody:""}}
function Po(a,b,c){a.requestTimeMs=String(b);M("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);!c&&(b=A("EVENT_ID"))&&(c=Vo(),a.serializedClientEventId={serializedEventId:b,clientCounter:String(c)})}
function Uo(a,b,c){D(a,2,b);if(!c&&(b=A("EVENT_ID"))){c=Vo();var d=new Ah;D(d,1,b);D(d,2,c);I(a,5,d)}}
function Vo(){var a=A("BATCH_CLIENT_COUNTER")||0;a||(a=Math.floor(Math.random()*uo/2));a++;a>uo&&(a=1);Kh("BATCH_CLIENT_COUNTER",a);return a}
function Oo(a,b,c){if(c.videoId)var d="VIDEO";else if(c.playlistId)d="PLAYLIST";else return;a.credentialTransferTokenTargetId=c;a.context=a.context||{};a.context.user=a.context.user||{};a.context.user.credentialTransferTokens=[{token:b,scope:d}]}
function To(a,b,c){if(id(c,1===ld(c,Ch)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;I(a,4,c);a=md(a,Mg,1)||new Mg;c=md(a,Kg,3)||new Kg;var e=new Jg;e.setToken(b);D(e,1,d);pd(c,12,Jg,e);I(a,3,c)}
function So(a){for(var b=[],c=0;c<a.length;c++)try{b.push(new xh(a[c]))}catch(d){Th(new Q("Transport failed to deserialize "+String(a[c])))}return b}
;var Wo=x.ytLoggingGelSequenceIdObj_||{};y("ytLoggingGelSequenceIdObj_",Wo);
function Xo(a,b,c,d){d=void 0===d?{}:d;if(M("lr_drop_other_and_business_payloads")){if(cn[a]||bn[a])return}else if(M("lr_drop_other_payloads")&&cn[a])return;var e={},f=Math.round(d.timestamp||P());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=un();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};M("log_sequence_info_on_gel_web")&&d.Y&&(a=e.context,b=d.Y,b={index:Yo(b),groupKey:b},a.sequence=b,d.tb&&delete Wo[d.Y]);(d.oc?Ko:Eo)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,
wa:d.wa},c)}
function Zo(a){Io(void 0,void 0,void 0===a?!1:a)}
function Yo(a){Wo[a]=a in Wo?Wo[a]+1:0;return Wo[a]}
;function Wj(a,b,c){c=void 0===c?{}:c;var d=an;A("ytLoggingEventsDefaultDisabled",!1)&&an==an&&(d=null);Xo(a,b,d,c)}
;var $o=[{fb:function(a){return"Cannot read property '"+a.key+"'"},
...
Qa:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var bp={ia:[],ha:[{la:ap,weight:500}]};function ap(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function cp(){this.ha=[];this.ia=[]}
var dp;function ep(){if(!dp){var a=dp=new cp;a.ia.length=0;a.ha.length=0;bp.ia&&a.ia.push.apply(a.ia,bp.ia);bp.ha&&a.ha.push.apply(a.ha,bp.ha)}return dp}
;var fp=new L;function gp(a){function b(){return a.charCodeAt(d++)}
var c=a.length,d=0;do{var e=hp(b);if(Infinity===e)break;var f=e>>3;switch(e&7){case 0:e=hp(b);if(2===f)return e;break;case 1:if(2===f)return;d+=8;break;case 2:e=hp(b);if(2===f)return a.substr(d,e);d+=e;break;case 5:if(2===f)return;d+=4;break;default:return}}while(d<c)}
function hp(a){var b=a(),c=b&127;if(128>b)return c;b=a();c|=(b&127)<<7;if(128>b)return c;b=a();c|=(b&127)<<14;if(128>b)return c;b=a();return 128>b?c|(b&127)<<21:Infinity}
;function ip(a,b,c,d){if(a)if(Array.isArray(a)){var e=d;for(d=0;d<a.length&&!(a[d]&&(e+=jp(d,a[d],b,c),500<e));d++);d=e}else if("object"===typeof a)for(e in a){if(a[e]){var f=a[e];var g=b;var h=c;g="string"!==typeof f||"clickTrackingParams"!==e&&"trackingParams"!==e?0:(f=gp(atob(f.replace(/-/g,"+").replace(/_/g,"/"))))?jp(e+".ve",f,g,h):0;d+=g;d+=jp(e,a[e],b,c);if(500<d)break}}else c[b]=kp(a),d+=c[b].length;else c[b]=kp(a),d+=c[b].length;return d}
function jp(a,b,c,d){c+="."+a;a=kp(b);d[c]=a;return c.length+a.length}
function kp(a){try{return("string"===typeof a?a:String(JSON.stringify(a))).substr(0,500)}catch(b){return"unable to serialize "+typeof a+" ("+b.message+")"}}
;var lp=x.ytLoggingGelSequenceIdObj_||{};y("ytLoggingGelSequenceIdObj_",lp);function mp(a,b,c){c=void 0===c?{}:c;var d=Math.round(c.timestamp||P());D(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=un();d=new wh;D(d,1,c.timestamp||!isFinite(e)?-1:e);if(M("log_sequence_info_on_gel_web")&&c.Y){e=c.Y;var f=Yo(e),g=new vh;D(g,2,f);D(g,1,e);I(d,3,g);c.tb&&delete lp[c.Y]}I(a,33,d);(c.oc?Mo:Ho)({endpoint:"log_event",payload:a,cttAuthInfo:c.cttAuthInfo,wa:c.wa},b)}
;function np(a,b){b=void 0===b?{}:b;var c=!1;A("ytLoggingEventsDefaultDisabled",!1)&&an===an&&(c=!0);mp(a,c?null:an,b)}
;function op(a,b,c){var d=new xh;od(d,73,yh,a);c?mp(d,c,b):np(d,b)}
function pp(a,b,c){var d=new xh;od(d,78,yh,a);c?mp(d,c,b):np(d,b)}
function qp(a,b,c){var d=new xh;od(d,208,yh,a);c?mp(d,c,b):np(d,b)}
function rp(a,b,c){var d=new xh;od(d,156,yh,a);c?mp(d,c,b):np(d,b)}
function sp(a,b,c){var d=new xh;od(d,215,yh,a);c?mp(d,c,b):np(d,b)}
function tp(a,b,c){var d=new xh;od(d,111,yh,a);c?mp(d,c,b):np(d,b)}
;var up=new Set,vp=0,wp=0,xp=0,yp=[],zp=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function Vj(a){Ap(a)}
function Bp(a){Ap(a,"WARNING")}
...
k.push("File name: "+a.fileName);k.push("Stacktrace: "+a.stack);window.console.log(k.join("\n"),a)}if(!(5<=vp)){var m=yp,q=re(a),u=q.message||"Unknown Error",B=q.name||"UnknownError",v=q.stack||a.j||"Not available";if(v.startsWith(B+": "+u)){var E=v.split("\n");E.shift();v=E.join("\n")}var F=q.lineNumber||"Not available",H=q.fileName||"Not available",R=v,O=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var S=0;S<a.args.length&&!(O=ip(a.args[S],"params."+S,g,O),500<=O);S++);else if(a.hasOwnProperty("params")&&
a.params){var ja=a.params;if("object"===typeof a.params)for(var N in ja){if(ja[N]){var Ba="params."+N,Oa=kp(ja[N]);g[Ba]=Oa;O+=Ba.length+Oa.length;if(500<O)break}}else g.params=kp(ja)}if(m.length)for(var va=0;va<m.length&&!(O=ip(m[va],"params.context."+va,g,O),500<=O);va++);navigator.vendor&&!g.hasOwnProperty("vendor")&&(g["device.vendor"]=navigator.vendor);var G={message:u,name:B,lineNumber:F,fileName:H,stack:R,params:g,sampleWeight:1},Ca=Number(a.columnNumber);isNaN(Ca)||(G.lineNumber=G.lineNumber+
":"+Ca);if("IGNORED"===a.level)var ua=0;else a:{for(var En=ep(),Fn=p(En.ia),ti=Fn.next();!ti.done;ti=Fn.next()){var Gn=ti.value;if(G.message&&G.message.match(Gn.cp)){ua=Gn.weight;break a}}for(var Hn=p(En.ha),ui=Hn.next();!ui.done;ui=Hn.next()){var In=ui.value;if(In.la(G)){ua=In.weight;break a}}ua=1}G.sampleWeight=ua;for(var Jn=p($o),vi=Jn.next();!vi.done;vi=Jn.next()){var wi=vi.value;if(wi.Qa[G.name])for(var Kn=p(wi.Qa[G.name]),xi=Kn.next();!xi.done;xi=Kn.next()){var Ln=xi.value,Mf=G.message.match(Ln.regexp);
if(Mf){G.params["params.error.original"]=Mf[0];for(var yi=Ln.groups,Mn={},Uc=0;Uc<yi.length;Uc++)Mn[yi[Uc]]=Mf[Uc+1],G.params["params.error."+yi[Uc]]=Mf[Uc+1];G.message=wi.fb(Mn);break}}}G.params||(G.params={});var Nn=ep();G.params["params.errorServiceSignature"]="msg="+Nn.ia.length+"&cb="+Nn.ha.length;G.params["params.serviceWorker"]="false";x.document&&x.document.querySelectorAll&&(G.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Cb("sample").constructor!==
Ab&&(G.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(G);if(0!==G.sampleWeight&&!up.has(G.message)){if("ERROR"===h){fp.ka("handleError",G);if(M("record_app_crashed_web")&&0===xp&&1===G.sampleWeight)if(xp++,M("errors_via_jspb")){var zi=new Zg;D(zi,1,1);if(!M("report_client_error_with_app_crash_ks")){var On=new Ug;D(On,1,G.message);var Pn=new Vg;I(Pn,3,On);var Qn=new Wg;I(Qn,5,Pn);var Rn=new Xg;I(Rn,9,Qn);I(zi,4,Rn)}var Sn=new xh;od(Sn,20,yh,zi);np(Sn)}else{var Tn=
{appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Tn.systemHealth={crashData:{clientError:{logMessage:{message:G.message}}}});Wj("appCrashed",Tn)}wp++}else"WARNING"===h&&fp.ka("handleWarning",G);if(M("kevlar_gel_error_routing"))a:{var Td=h;if(M("errors_via_jspb")){if(Cp())var Vn=void 0;else{var Vc=new Rg;D(Vc,1,G.stack);G.fileName&&D(Vc,4,G.fileName);var qb=G.lineNumber&&G.lineNumber.split?G.lineNumber.split(":"):[];0!==qb.length&&(1!==qb.length||isNaN(Number(qb[0]))?
2!==qb.length||isNaN(Number(qb[0]))||isNaN(Number(qb[1]))||(D(Vc,2,Number(qb[0])),D(Vc,3,Number(qb[1]))):D(Vc,2,Number(qb[0])));var jc=new Ug;D(jc,1,G.message);D(jc,3,G.name);D(jc,6,G.sampleWeight);"ERROR"===Td?D(jc,2,2):"WARNING"===Td?D(jc,2,1):D(jc,2,0);var Ai=new Sg;D(Ai,1,!0);od(Ai,3,Tg,Vc);var Jb=new Og;D(Jb,3,window.location.href);for(var Wn=A("FEXP_EXPERIMENTS",[]),Bi=0;Bi<Wn.length;Bi++){var kt=Wn[Bi];Zc(Jb);jd(Jb,5).push(kt)}var Ci=A("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Lh()&&Ci)for(var Xn=
p(Object.keys(Ci)),kc=Xn.next();!kc.done;kc=Xn.next()){var Yn=kc.value,Di=new Qg;D(Di,1,Yn);Di.setValue(String(Ci[Yn]));pd(Jb,4,Qg,Di)}var Ei=G.params;if(Ei){var Zn=p(Object.keys(Ei));for(kc=Zn.next();!kc.done;kc=Zn.next()){var $n=kc.value,Fi=new Qg;D(Fi,1,"client."+$n);Fi.setValue(String(Ei[$n]));pd(Jb,4,Qg,Fi)}}var ao=A("SERVER_NAME"),bo=A("SERVER_VERSION");if(ao&&bo){var Gi=new Qg;D(Gi,1,"server.name");Gi.setValue(ao);pd(Jb,4,Qg,Gi);var Hi=new Qg;D(Hi,1,"server.version");Hi.setValue(bo);pd(Jb,
4,Qg,Hi)}var Nf=new Vg;I(Nf,1,Jb);I(Nf,2,Ai);I(Nf,3,jc);Vn=Nf}var co=Vn;if(!co)break a;var eo=new xh;od(eo,163,yh,co);np(eo)}else{if(Cp())var fo=void 0;else{var Ud={stackTrace:G.stack};G.fileName&&(Ud.filename=G.fileName);var rb=G.lineNumber&&G.lineNumber.split?G.lineNumber.split(":"):[];0!==rb.length&&(1!==rb.length||isNaN(Number(rb[0]))?2!==rb.length||isNaN(Number(rb[0]))||isNaN(Number(rb[1]))||(Ud.lineNumber=Number(rb[0]),Ud.columnNumber=Number(rb[1])):Ud.lineNumber=Number(rb[0]));var Ii={level:"ERROR_LEVEL_UNKNOWN",
message:G.message,errorClassName:G.name,sampleWeight:G.sampleWeight};"ERROR"===Td?Ii.level="ERROR_LEVEL_ERROR":"WARNING"===Td&&(Ii.level="ERROR_LEVEL_WARNNING");var lt={isObfuscated:!0,browserStackInfo:Ud},Wc={pageUrl:window.location.href,kvPairs:[]};A("FEXP_EXPERIMENTS")&&(Wc.experimentIds=A("FEXP_EXPERIMENTS"));var Ji=A("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Lh()&&Ji)for(var go=p(Object.keys(Ji)),lc=go.next();!lc.done;lc=go.next()){var ho=lc.value;Wc.kvPairs.push({key:ho,value:String(Ji[ho])})}var Ki=
G.params;if(Ki){var io=p(Object.keys(Ki));for(lc=io.next();!lc.done;lc=io.next()){var jo=lc.value;Wc.kvPairs.push({key:"client."+jo,value:String(Ki[jo])})}}var ko=A("SERVER_NAME"),lo=A("SERVER_VERSION");ko&&lo&&(Wc.kvPairs.push({key:"server.name",value:ko}),Wc.kvPairs.push({key:"server.version",value:lo}));fo={errorMetadata:Wc,stackTrace:lt,logMessage:Ii}}var mo=fo;if(!mo)break a;Wj("clientError",mo)}if("ERROR"===Td||M("errors_flush_gel_always_killswitch"))M("web_fp_via_jspb")&&Zo(!0),Zo()}if(!M("suppress_error_204_logging")){var Vd=
G.params||{},Kb={urlParams:{a:"logerror",t:"jserror",type:G.name,msg:G.message.substr(0,250),line:G.lineNumber,level:h,"client.name":Vd.name},postParams:{url:A("PAGE_NAME",window.location.href),file:G.fileName},method:"POST"};Vd.version&&(Kb["client.version"]=Vd.version);if(Kb.postParams){G.stack&&(Kb.postParams.stack=G.stack);for(var no=p(Object.keys(Vd)),Li=no.next();!Li.done;Li=no.next()){var oo=Li.value;Kb.postParams["client."+oo]=Vd[oo]}var Mi=A("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(Mi)for(var po=
p(Object.keys(Mi)),Ni=po.next();!Ni.done;Ni=po.next()){var qo=Ni.value;Kb.postParams[qo]=Mi[qo]}var ro=A("SERVER_NAME"),so=A("SERVER_VERSION");ro&&so&&(Kb.postParams["server.name"]=ro,Kb.postParams["server.version"]=so)}Oi(A("ECATCHER_REPORT_HOST","")+"/error_204",Kb)}try{up.add(G.message)}catch(Ku){}vp++}}}}
function Cp(){for(var a=p(zp),b=a.next();!b.done;b=a.next())if(Nj(b.value.toLowerCase()))return!0;return!1}
function Dp(a){var b=Ja.apply(1,arguments);a.args||(a.args=[]);a.args.push.apply(a.args,fa(b))}
;function Ep(){this.register=new Map}
function Fp(a){a=p(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.gp("ABORTED")}
Ep.prototype.clear=function(){Fp(this);this.register.clear()};
var Gp=new Ep;var Hp=Date.now().toString();
function Ip(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=Date.now();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(Hp)for(a=1,b=0;b<Hp.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^Hp.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var Jp=x.ytLoggingDocDocumentNonce_;Jp||(Jp=Ip(),y("ytLoggingDocDocumentNonce_",Jp));var Kp=Jp;var Lp={Cg:0,rd:1,Bd:2,kk:3,Eg:4,vo:5,al:6,Fm:7,dm:8,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS"};function Mp(a){this.i=a}
function Np(a){return new Mp({trackingParams:a})}
Mp.prototype.getAsJson=function(){var a={};void 0!==this.i.trackingParams?a.trackingParams=this.i.trackingParams:(a.veType=this.i.veType,void 0!==this.i.veCounter&&(a.veCounter=this.i.veCounter),void 0!==this.i.elementIndex&&(a.elementIndex=this.i.elementIndex));void 0!==this.i.dataElement&&(a.dataElement=this.i.dataElement.getAsJson());void 0!==this.i.youtubeData&&(a.youtubeData=this.i.youtubeData);return a};
Mp.prototype.getAsJspb=function(){var a=new ah;void 0!==this.i.trackingParams?D(a,1,this.i.trackingParams):(void 0!==this.i.veType&&D(a,2,this.i.veType),void 0!==this.i.veCounter&&D(a,6,this.i.veCounter),void 0!==this.i.elementIndex&&D(a,3,this.i.elementIndex));if(void 0!==this.i.dataElement){var b=this.i.dataElement.getAsJspb();I(a,7,b)}void 0!==this.i.youtubeData&&I(a,8,this.i.jspbYoutubeData);return a};
Mp.prototype.toString=function(){return JSON.stringify(this.getAsJson())};
Mp.prototype.isClientVe=function(){return!this.i.trackingParams&&!!this.i.veType};function Op(a){a=void 0===a?0:a;return 0===a?"client-screen-nonce":"client-screen-nonce."+a}
function Pp(a){a=void 0===a?0:a;return 0===a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function Qp(a){return A(Pp(void 0===a?0:a))}
y("yt_logging_screen.getRootVeType",Qp);function Rp(a){return(a=Qp(void 0===a?0:a))?new Mp({veType:a,youtubeData:void 0,jspbYoutubeData:void 0}):null}
function Sp(){var a=A("csn-to-ctt-auth-info");a||(a={},Kh("csn-to-ctt-auth-info",a));return a}
function Tp(a){a=A(Op(void 0===a?0:a));if(!a&&!A("USE_CSN_FALLBACK",!0))return null;a||(a="UNDEFINED_CSN");return a?a:null}
y("yt_logging_screen.getCurrentCsn",Tp);function Up(a,b,c){var d=Sp();(c=Tp(c))&&delete d[c];b&&(d[a]=b)}
function Vp(a){return Sp()[a]}
y("yt_logging_screen.getCttAuthInfo",Vp);
function Wp(a,b,c,d){c=void 0===c?0:c;if(a!==A(Op(c))||b!==A(Pp(c)))Up(a,d,c),Kh(Op(c),a),Kh(Pp(c),b),b=function(){setTimeout(function(){if(a)if(M("web_time_via_jspb")){var e=new bh;D(e,1,Kp);D(e,2,a);M("use_default_heartbeat_client")?tp(e):tp(e,void 0,an)}else e={clientDocumentNonce:Kp,clientScreenNonce:a},M("use_default_heartbeat_client")?Wj("foregroundHeartbeatScreenAssociated",e):Xo("foregroundHeartbeatScreenAssociated",e,an)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):
b()}
y("yt_logging_screen.setCurrentScreen",Wp);var Xp=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};y("yt.msgs_",Xp);function Yp(a){Fh(Xp,arguments)}
;var Zp={qd:3611,Ec:27686,Fc:85013,Gc:23462,Ic:42016,Jc:62407,Kc:26926,Hc:43781,Lc:51236,Mc:79148,Nc:50160,Oc:77504,bd:87907,cd:18630,dd:54445,ed:80935,fd:105675,gd:37521,hd:147285,jd:47786,kd:98349,ld:123695,md:6827,nd:29434,od:7282,pd:124448,td:32276,sd:76278,ud:147868,vd:147869,wd:93911,xd:106531,yd:27259,zd:27262,Ad:27263,Cd:21759,Dd:27107,Ed:62936,Fd:49568,Gd:38408,Hd:80637,Id:68727,Jd:68728,Kd:80353,Ld:80356,Md:74610,Nd:45707,Od:83962,Pd:83970,Qd:46713,Rd:89711,Sd:74612,Td:93265,Ud:74611,Vd:131380,
...
Ei:139095,Fi:144402,Gi:149968,Hi:149969,Ii:32473,Ji:72901,Ki:72906,Li:50947,Mi:50612,Ni:50613,Oi:50942,Pi:84938,Qi:84943,Ri:84939,Si:84941,Ti:84944,Ui:84940,Vi:84942,Wi:35585,Xi:51926,Yi:79983,Zi:63238,aj:18921,bj:63241,cj:57893,dj:41182,ej:135732,fj:33424,gj:22207,hj:42993,ij:36229,jj:22206,kj:22205,lj:18993,mj:19001,nj:18990,oj:18991,pj:18997,qj:18725,rj:19003,sj:36874,tj:44763,uj:33427,vj:67793,wj:22182,xj:37091,yj:34650,zj:50617,Aj:47261,Bj:22287,Cj:25144,Dj:97917,Ej:62397,Fj:150871,Gj:150874,
Hj:125598,Ij:137935,Jj:36961,Kj:108035,Lj:27426,Mj:27857,Nj:27846,Oj:27854,Pj:69692,Qj:61411,Rj:39299,Sj:38696,Tj:62520,Uj:36382,Vj:108701,Wj:50663,Xj:36387,Yj:14908,Zj:37533,ak:105443,bk:61635,ck:62274,dk:133818,ek:65702,fk:65703,gk:65701,hk:76256,ik:37671,jk:49953,lk:36216,mk:28237,nk:39553,pk:29222,qk:26107,rk:38050,sk:26108,uk:120745,tk:26109,vk:26110,wk:66881,xk:28236,yk:14586,zk:57929,Ak:74723,Bk:44098,Ck:44099,Fk:23528,Gk:61699,Dk:134104,Ek:134103,Hk:59149,Ik:101951,Jk:97346,Kk:118051,Lk:95102,
Mk:64882,Nk:119505,Ok:63595,Pk:63349,Qk:95101,Rk:75240,Sk:27039,Tk:68823,Uk:21537,Vk:83464,Wk:75707,Xk:83113,Yk:101952,Zk:101953,bl:79610,dl:125755,fl:24402,il:24400,jl:32925,kl:57173,ll:122502,ml:145268,nl:138480,ol:64423,pl:64424,ql:33986,rl:100828,sl:129089,ul:21409,yl:135155,zl:135156,Al:135157,Bl:135158,Cl:135159,Dl:135160,El:135161,Fl:135162,Gl:135163,Hl:135164,Il:135165,Jl:135166,vl:11070,wl:11074,xl:17880,Kl:14001,Ml:30709,Nl:30707,Ol:30711,Pl:30710,Ql:30708,Ll:26984,Rl:146143,Sl:63648,Tl:63649,
Ul:51879,Vl:111059,Wl:5754,Xl:20445,Zl:130975,Yl:130976,am:110386,bm:113746,cm:66557,em:17310,fm:28631,gm:21589,hm:68012,im:60480,jm:138664,km:141121,lm:31571,mm:141978,nm:150105,om:150106,pm:150107,qm:150108,rm:76980,sm:41577,tm:45469,um:38669,vm:13768,wm:13777,xm:141842,ym:62985,zm:4724,Am:59369,Bm:43927,Cm:43928,Dm:12924,Em:100355,Hm:56219,Im:27669,Jm:10337,Gm:47896,Km:122629,Mm:139723,Lm:139722,Nm:121258,Om:107598,Pm:127991,Qm:96639,Rm:107536,Sm:130169,Tm:96661,Um:145188,Vm:96658,Wm:116646,Xm:121122,
Ym:96660,Zm:127738,an:127083,bn:147842,cn:104443,dn:96659,en:147595,fn:106442,gn:134840,hn:63667,jn:63668,kn:63669,ln:130686,mn:147036,nn:78314,pn:147799,qn:148649,rn:55761,sn:127098,tn:134841,un:96368,vn:67374,wn:48992,xn:146176,yn:49956,zn:31961,An:26388,Bn:23811,Cn:5E4,Dn:126250,En:96370,Fn:47355,Gn:47356,Hn:37935,In:45521,Jn:21760,Kn:83769,Ln:49977,Mn:49974,Nn:93497,On:93498,Pn:34325,Qn:140759,Rn:115803,Sn:123707,Tn:100081,Un:35309,Vn:68314,Wn:25602,Xn:100339,Yn:143516,Zn:59018,ao:18248,bo:50625,
co:9729,eo:37168,fo:37169,ho:21667,jo:16749,ko:18635,lo:39305,mo:18046,no:53969,oo:8213,po:93926,qo:102852,ro:110099,so:22678,to:69076,uo:137575,wo:139224,xo:100856,yo:17736,zo:3832,Ao:147111,Bo:55759,Co:64031,Io:93044,Jo:93045,Ko:34388,Lo:17657,Mo:17655,No:39579,Oo:39578,Po:77448,Qo:8196,Ro:11357,So:69877,To:8197,Uo:82039};function $p(){var a=ub(aq),b;return $f(new Tf(function(c,d){a.onSuccess=function(e){li(e)?c(new bq(e)):d(new cq("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new cq("Unknown request error","net.unknown",e))};
a.onTimeout=function(e){d(new cq("Request timed out","net.timeout",e))};
b=Oi("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof ag&&b.abort();
return Yf(c)})}
function cq(a,b,c){$a.call(this,a+", errorCode="+b);this.errorCode=b;this.xhr=c;this.name="PromiseAjaxError"}
r(cq,$a);function bq(a){this.xhr=a}
;function dq(){this.j=0;this.i=null}
dq.prototype.then=function(a,b,c){return 1===this.j&&a?(a=a.call(c,this.i))&&"function"===typeof a.then?a:eq(a):2===this.j&&b?(a=b.call(c,this.i))&&"function"===typeof a.then?a:fq(a):this};
dq.prototype.getValue=function(){return this.i};
dq.prototype.$goog_Thenable=!0;function fq(a){var b=new dq;a=void 0===a?null:a;b.j=2;b.i=void 0===a?null:a;return b}
function eq(a){var b=new dq;a=void 0===a?null:a;b.j=1;b.i=void 0===a?null:a;return b}
;function gq(){if(ke()||Mj&&Nj("applewebkit")&&!Nj("version")&&(!Nj("safari")||Nj("gsa/"))||vc&&Nj("version/"))return!0;if(M("enable_web_eom_visitor_data"))return A("EOM_VISITOR_DATA")?!1:!0;var a=A("INNERTUBE_CLIENT_NAME");return!a||"WEB"!==a&&"MWEB"!==a?!0:(a=Zi("CONSENT"))?a.startsWith("YES+"):!0}
;function hq(a){$a.call(this,a.message||a.description||a.name);this.isMissing=a instanceof iq;this.isTimeout=a instanceof cq&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof ag}
r(hq,$a);hq.prototype.name="BiscottiError";function iq(){$a.call(this,"Biscotti ID is missing from server")}
r(iq,$a);iq.prototype.name="BiscottiMissingError";var aq={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},jq=null;function Wh(){if(M("disable_biscotti_fetch_entirely_for_all_web_clients"))return Yf(Error("Biscotti id fetching has been disabled entirely."));if(!gq())return Yf(Error("User has not consented - not fetching biscotti id."));if("1"==sb())return Yf(Error("Biscotti ID is not available in private embed mode"));jq||(jq=$f($p().then(kq),function(a){return lq(2,a)}));
return jq}
function kq(a){a=a.xhr.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new iq;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new iq;a=a.id;Xh(a);jq=eq(a);mq(18E5,2);return a}
function lq(a,b){b=new hq(b);Xh("");jq=fq(b);0<a&&mq(12E4,a-1);throw b;}
function mq(a,b){mi(function(){$f($p().then(kq,function(c){return lq(b,c)}),bb)},a)}
function nq(){try{var a=z("yt.ads.biscotti.getId_");return a?a():Wh()}catch(b){return Yf(b)}}
;function oq(a){if("1"!=sb()){a&&Vh();try{nq().then(function(){},function(){}),mi(oq,18E5)}catch(b){Th(b)}}}
;function pq(){this.zc=!0}
function qq(a){var b={},c=me([]);c&&(b.Authorization=c,c=a=null==a?void 0:a.sessionIndex,void 0===c&&(c=Number(A("SESSION_INDEX",0)),c=isNaN(c)?0:c),M("voice_search_auth_header_removal")||(b["X-Goog-AuthUser"]=c),"INNERTUBE_HOST_OVERRIDE"in Jh||(b["X-Origin"]=window.location.origin),void 0===a&&"DELEGATED_SESSION_ID"in Jh&&(b["X-Goog-PageId"]=A("DELEGATED_SESSION_ID")));return b}
;var rq=Symbol("injectionDeps");function sq(a){this.name=a}
sq.prototype.toString=function(){return"InjectionToken("+this.name+")"};
function tq(){this.key=uq}
function vq(){this.providers=new Map;this.i=new Map}
vq.prototype.resolve=function(a){return a instanceof tq?wq(this,a.key,[],!0):wq(this,a,[])};
function wq(a,b,c,d){d=void 0===d?!1:d;if(-1<c.indexOf(b))throw Error("Deps cycle for: "+b);if(a.i.has(b))return a.i.get(b);if(!a.providers.has(b)){if(d)return;throw Error("No provider for: "+b);}d=a.providers.get(b);c.push(b);if(d.Dc)var e=d.Dc;else if(d.Cc)e=d[rq]?xq(a,d[rq],c):[],e=d.Cc.apply(d,fa(e));else if(d.Kb){e=d.Kb;var f=e[rq]?xq(a,e[rq],c):[];e=new (Function.prototype.bind.apply(e,[null].concat(fa(f))))}else throw Error("Could not resolve providers for: "+b);c.pop();d.kp||a.i.set(b,e);
return e}
function xq(a,b,c){return b?b.map(function(d){return d instanceof tq?wq(a,d.key,c,!0):wq(a,d,c)}):[]}
;var yq;var zq={identityType:"UNAUTHENTICATED_IDENTITY_TYPE_UNKNOWN"};var Aq=new Map([["dark","USER_INTERFACE_THEME_DARK"],["light","USER_INTERFACE_THEME_LIGHT"]]);function Bq(){var a=void 0===a?window.location.href:a;if(M("kevlar_disable_theme_param"))return null;ac(bc(5,a));try{var b=ei(a).theme;return Aq.get(b)||null}catch(c){}return null}
;function Cq(){this.i={};if(this.j=$i()){var a=Zi("CONSISTENCY");a&&Dq(this,{encryptedTokenJarContents:a})}}
Cq.prototype.handleResponse=function(a,b){var c,d;b=(null==(c=b.ca.context)?void 0:null==(d=c.request)?void 0:d.consistencyTokenJars)||[];var e;if(a=null==(e=a.responseContext)?void 0:e.consistencyTokenJar){e=p(b);for(c=e.next();!c.done;c=e.next())delete this.i[c.value.encryptedTokenJarContents];Dq(this,a)}};
function Dq(a,b){if(b.encryptedTokenJarContents&&(a.i[b.encryptedTokenJarContents]=b,"string"===typeof b.expirationSeconds)){var c=Number(b.expirationSeconds);setTimeout(function(){delete a.i[b.encryptedTokenJarContents]},1E3*c);
a.j&&Yi("CONSISTENCY",b.encryptedTokenJarContents,c,void 0,!0)}}
;var Eq=window.location.hostname.split(".").slice(-2).join(".");function Fq(){var a=A("LOCATION_PLAYABILITY_TOKEN");"TVHTML5"===A("INNERTUBE_CLIENT_NAME")&&(this.i=Gq(this))&&(a=this.i.get("yt-location-playability-token"));a&&(this.locationPlayabilityToken=a,this.j=void 0)}
var Hq;Fq.getInstance=function(){Hq=z("yt.clientLocationService.instance");Hq||(Hq=new Fq,y("yt.clientLocationService.instance",Hq));return Hq};
Fq.prototype.setLocationOnInnerTubeContext=function(a){a.client||(a.client={});this.j?(a.client.locationInfo||(a.client.locationInfo={}),a.client.locationInfo.latitudeE7=Math.floor(1E7*this.j.coords.latitude),a.client.locationInfo.longitudeE7=Math.floor(1E7*this.j.coords.longitude),a.client.locationInfo.horizontalAccuracyMeters=Math.round(this.j.coords.accuracy),a.client.locationInfo.forceLocationPlayabilityTokenRefresh=!0):this.locationPlayabilityToken&&(a.client.locationPlayabilityToken=this.locationPlayabilityToken)};
Fq.prototype.handleResponse=function(a){var b;a=null==(b=a.responseContext)?void 0:b.locationPlayabilityToken;void 0!==a&&(this.locationPlayabilityToken=a,this.j=void 0,"TVHTML5"===A("INNERTUBE_CLIENT_NAME")?(this.i=Gq(this))&&this.i.set("yt-location-playability-token",a,15552E3):Yi("YT_CL",JSON.stringify({loctok:a}),15552E3,Eq,!0))};
function Gq(a){return void 0===a.i?new xj("yt-client-location"):a.i}
Fq.prototype.getCurrentPositionFromGeolocation=function(){var a=this;if(!(navigator&&navigator.geolocation&&navigator.geolocation.getCurrentPosition)||!M("web_enable_browser_geolocation_api")&&!M("enable_handoff_location_2fa_on_mweb"))return Promise.reject(Error("Geolocation unsupported"));var b=!1,c=1E4;M("enable_handoff_location_2fa_on_mweb")&&(b=!0,c=15E3);return new Promise(function(d,e){navigator.geolocation.getCurrentPosition(function(f){a.j=f;d(f)},function(f){e(f)},{enableHighAccuracy:b,
maximumAge:0,timeout:c})})};
Fq.prototype.createUnpluggedLocationInfo=function(a){var b={};a=a.coords;if(null==a?0:a.latitude)b.latitudeE7=Math.floor(1E7*a.latitude);if(null==a?0:a.longitude)b.longitudeE7=Math.floor(1E7*a.longitude);if(null==a?0:a.accuracy)b.locationRadiusMeters=Math.round(a.accuracy);return b};function Iq(a,b){var c;if((null==(c=a.signalServiceEndpoint)?0:c.signal)&&b.Aa&&(c=b.Aa[a.signalServiceEndpoint.signal]))return c();var d;if((null==(d=a.continuationCommand)?0:d.request)&&b.Rb&&(d=b.Rb[a.continuationCommand.request]))return d();for(var e in a)if(b.ob[e]&&(a=b.ob[e]))return a()}
;function Jq(a){return function(){return new a}}
;var Kq={},Lq=(Kq.WEB_UNPLUGGED="^unplugged/",Kq.WEB_UNPLUGGED_ONBOARDING="^unplugged/",Kq.WEB_UNPLUGGED_OPS="^unplugged/",Kq.WEB_UNPLUGGED_PUBLIC="^unplugged/",Kq.WEB_CREATOR="^creator/",Kq.WEB_KIDS="^kids/",Kq.WEB_EXPERIMENTS="^experiments/",Kq.WEB_MUSIC="^music/",Kq.WEB_REMIX="^music/",Kq.WEB_MUSIC_EMBEDDED_PLAYER="^music/",Kq.WEB_MUSIC_EMBEDDED_PLAYER="^main_app/|^sfv/",Kq);
function Mq(a){var b=void 0===b?"UNKNOWN_INTERFACE":b;if(1===a.length)return a[0];var c=Lq[b];if(c){var d=new RegExp(c),e=p(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,d.exec(c))return c}var f=[];Object.entries(Lq).forEach(function(g){var h=p(g);g=h.next().value;h=h.next().value;b!==g&&f.push(h)});
d=new RegExp(f.join("|"));a.sort(function(g,h){return g.length-h.length});
e=p(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,!d.exec(c))return c;return a[0]}
;function Nq(a,b){return{method:void 0===b?"POST":b,mode:gi(a)?"same-origin":"cors",credentials:gi(a)?"same-origin":"include"}}
;function Oq(){}
Oq.prototype.s=function(a,b,c){b=void 0===b?{}:b;c=void 0===c?zq:c;var d=a.clickTrackingParams,e=this.m,f=!1;f=void 0===f?!1:f;e=void 0===e?!1:e;var g=A("INNERTUBE_CONTEXT");if(g){g=vb(g);M("web_no_tracking_params_in_shell_killswitch")||delete g.clickTracking;g.client||(g.client={});var h=g.client;"MWEB"===h.clientName&&(h.clientFormFactor=A("IS_TABLET")?"LARGE_FORM_FACTOR":"SMALL_FORM_FACTOR");h.screenWidthPoints=window.innerWidth;h.screenHeightPoints=window.innerHeight;h.screenPixelDensity=Math.round(window.devicePixelRatio||
1);h.screenDensityFloat=window.devicePixelRatio||1;h.utcOffsetMinutes=-Math.floor((new Date).getTimezoneOffset());var k=void 0===k?!1:k;bj.getInstance();var m="USER_INTERFACE_THEME_LIGHT";ej(165)?m="USER_INTERFACE_THEME_DARK":ej(174)?m="USER_INTERFACE_THEME_LIGHT":!M("kevlar_legacy_browsers")&&window.matchMedia&&window.matchMedia("(prefers-color-scheme)").matches&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(m="USER_INTERFACE_THEME_DARK");k=k?m:Bq()||m;h.userInterfaceTheme=k;if(!f){if(k=
...
if(!M("web_populate_time_zone_itc_killswitch")){b:{if("undefined"!==typeof Intl)try{var B=(new Intl.DateTimeFormat).resolvedOptions().timeZone;break b}catch(Oa){}B=void 0}B&&(h.timeZone=B)}(B=Oh())?h.experimentsToken=B:delete h.experimentsToken;B=Ph();Cq.i||(Cq.i=new Cq);h=Cq.i.i;u=[];q=0;for(var v in h)u[q++]=h[v];g.request=Object.assign({},g.request,{internalExperimentFlags:B,consistencyTokenJars:u});!M("web_prequest_context_killswitch")&&(v=A("INNERTUBE_CONTEXT_PREQUEST_CONTEXT"))&&(g.request.externalPrequestContext=
v);B=bj.getInstance();v=ej(58);B=B.get("gsml","");g.user=Object.assign({},g.user);v&&(g.user.enableSafetyMode=v);B&&(g.user.lockedSafetyMode=!0);M("warm_op_csn_cleanup")?e&&(f=Tp())&&(g.clientScreenNonce=f):!f&&(f=Tp())&&(g.clientScreenNonce=f);d&&(g.clickTracking={clickTrackingParams:d});if(d=z("yt.mdx.remote.remoteClient_"))g.remoteClient=d;M("web_enable_client_location_service")&&Fq.getInstance().setLocationOnInnerTubeContext(g);try{var E=hi(),F=E.bid;delete E.bid;g.adSignalsInfo={params:[],bid:F};
var H=p(Object.entries(E));for(var R=H.next();!R.done;R=H.next()){var O=p(R.value),S=O.next().value,ja=O.next().value;E=S;F=ja;d=void 0;null==(d=g.adSignalsInfo.params)||d.push({key:E,value:""+F})}}catch(Oa){Ap(Oa)}H=g}else Ap(Error("Error: No InnerTubeContext shell provided in ytconfig.")),H={};H={context:H};if(R=this.i(a)){this.j(H,R,b);var N;b="/youtubei/v1/"+Mq(this.l());var Ba;(a=null==(N=a.commandMetadata)?void 0:null==(Ba=N.webCommandMetadata)?void 0:Ba.apiUrl)&&(b=a);N=b;(Ba=A("INNERTUBE_HOST_OVERRIDE"))&&
(N=String(Ba)+String(dc(N)));Ba={};Ba.key=A("INNERTUBE_API_KEY");M("json_condensed_response")&&(Ba.prettyPrint="false");N=fi(N,Ba||{},!1);N={input:N,sa:Nq(N),ca:H,config:Object.assign({},void 0)};N.config.Ha?N.config.Ha.identity=c:N.config.Ha={identity:c};return N}Ap(new Q("Error: Failed to create Request from Command.",a))};
da.Object.defineProperties(Oq.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!1}}});function Pq(){}
r(Pq,Oq);Pq.prototype.s=function(){return{input:"/getDatasyncIdsEndpoint",sa:Nq("/getDatasyncIdsEndpoint","GET"),ca:{}}};
Pq.prototype.l=function(){return[]};
Pq.prototype.i=function(){};
Pq.prototype.j=function(){};var Qq={},Rq=(Qq.GET_DATASYNC_IDS=Jq(Pq),Qq);function Sq(a){var b=Ja.apply(1,arguments);if(!Tq(a)||b.some(function(d){return!Tq(d)}))throw Error("Only objects may be merged.");
b=p(b);for(var c=b.next();!c.done;c=b.next())Uq(a,c.value);return a}
function Uq(a,b){for(var c in b)if(Tq(b[c])){if(c in a&&!Tq(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});Uq(a[c],b[c])}else if(Vq(b[c])){if(c in a&&!Vq(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);Wq(a[c],b[c])}else a[c]=b[c];return a}
function Wq(a,b){b=p(b);for(var c=b.next();!c.done;c=b.next())c=c.value,Tq(c)?a.push(Uq({},c)):Vq(c)?a.push(Wq([],c)):a.push(c);return a}
function Tq(a){return"object"===typeof a&&!Array.isArray(a)}
function Vq(a){return"object"===typeof a&&Array.isArray(a)}
;function Xq(a,b){Dl.call(this,1,arguments);this.timer=b}
r(Xq,Dl);var Yq=new El("aft-recorded",Xq);var Zq=window;function $q(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var T=Zq.performance||Zq.mozPerformance||Zq.msPerformance||Zq.webkitPerformance||new $q;var ar=!1,br={'script[name="scheduler/scheduler"]':"sj",'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'link[rel="stylesheet"][name="player/www-player"]':"pc",'script[name="desktop_polymer/desktop_polymer"]':"dpj",'link[rel="import"][name="desktop_polymer"]':"dph",'script[name="mobile-c3"]':"mcj",'link[rel="stylesheet"][name="mobile-c3"]':"mcc",'script[name="player-plasma-ias-phone/base"]':"mcppj",'script[name="player-plasma-ias-tablet/base"]':"mcptj",'link[rel="stylesheet"][name="mobile-polymer-player-ias"]':"mcpc",
'link[rel="stylesheet"][name="mobile-polymer-player-svg-ias"]':"mcpsc",'script[name="mobile_blazer_core_mod"]':"mbcj",'link[rel="stylesheet"][name="mobile_blazer_css"]':"mbc",'script[name="mobile_blazer_logged_in_users_mod"]':"mbliuj",'script[name="mobile_blazer_logged_out_users_mod"]':"mblouj",'script[name="mobile_blazer_noncore_mod"]':"mbnj","#player_css":"mbpc",'script[name="mobile_blazer_desktopplayer_mod"]':"mbpj",'link[rel="stylesheet"][name="mobile_blazer_tablet_css"]':"mbtc",'script[name="mobile_blazer_watch_mod"]':"mbwj"};
Wa(T.clearResourceTimings||T.webkitClearResourceTimings||T.mozClearResourceTimings||T.msClearResourceTimings||T.oClearResourceTimings||bb,T);function cr(a){var b=dr(a);if(b.aft)return b.aft;a=A((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function er(){var a;if(M("csi_use_performance_navigation_timing")){var b,c,d,e=null==T?void 0:null==(a=T.getEntriesByType)?void 0:null==(b=a.call(T,"navigation"))?void 0:null==(c=b[0])?void 0:null==(d=c.toJSON)?void 0:d.call(c);e?(e.requestStart=fr(e.requestStart),e.responseEnd=fr(e.responseEnd),e.redirectStart=fr(e.redirectStart),e.redirectEnd=fr(e.redirectEnd),e.domainLookupEnd=fr(e.domainLookupEnd),e.connectStart=fr(e.connectStart),e.connectEnd=fr(e.connectEnd),e.responseStart=fr(e.responseStart),
e.secureConnectionStart=fr(e.secureConnectionStart),e.domainLookupStart=fr(e.domainLookupStart),e.isPerformanceNavigationTiming=!0,a=e):a=T.timing}else a=T.timing;return a}
function gr(){return M("csi_use_time_origin")&&T.timeOrigin?Math.floor(T.timeOrigin):T.timing.navigationStart}
function fr(a){return Math.round(gr()+a)}
function hr(a){var b;(b=z("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},y("ytcsi."+(a||"")+"data_",b));return b}
function ir(a){a=hr(a);a.info||(a.info={});return a.info}
function dr(a){a=hr(a);a.tick||(a.tick={});return a.tick}
function jr(a){a=hr(a);if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}else a.gel={gelTicks:{},gelInfos:{}};return a.gel}
function kr(a){a=jr(a);a.gelInfos||(a.gelInfos={});return a.gelInfos}
function lr(a){var b=hr(a).nonce;b||(b=Ip(),hr(a).nonce=b);return b}
function mr(a){var b=dr(a||""),c=cr(a);c&&!ar&&(Jl(Yq,new Xq(Math.round(c-b._start),a)),ar=!0)}
function nr(a,b){for(var c=p(Object.keys(b)),d=c.next();!d.done;d=c.next())if(d=d.value,!Object.keys(a).includes(d)||"object"===typeof b[d]&&!nr(a[d],b[d]))return!1;return!0}
;function or(){if(T.getEntriesByType){var a=T.getEntriesByType("paint");if(a=ib(a,function(b){return"first-paint"===b.name}))return fr(a.startTime)}a=T.timing;
return a.dc?Math.max(0,a.dc):0}
;function pr(){var a=z("ytcsi.debug");a||(a=[],y("ytcsi.debug",a),y("ytcsi.reference",{}));return a}
function qr(a){a=a||"";var b=z("ytcsi.reference");b||(pr(),b=z("ytcsi.reference"));if(b[a])return b[a];var c=pr(),d={timerName:a,info:{},tick:{},span:{},jspbInfo:[]};c.push(d);return b[a]=d}
;var U={},rr=(U.auto_search="LATENCY_ACTION_AUTO_SEARCH",U.ad_to_ad="LATENCY_ACTION_AD_TO_AD",U.ad_to_video="LATENCY_ACTION_AD_TO_VIDEO",U["analytics.explore"]="LATENCY_ACTION_CREATOR_ANALYTICS_EXPLORE",U.app_startup="LATENCY_ACTION_APP_STARTUP",U["artist.analytics"]="LATENCY_ACTION_CREATOR_ARTIST_ANALYTICS",U["artist.events"]="LATENCY_ACTION_CREATOR_ARTIST_CONCERTS",U["artist.presskit"]="LATENCY_ACTION_CREATOR_ARTIST_PROFILE",U.browse="LATENCY_ACTION_BROWSE",U.cast_splash="LATENCY_ACTION_CAST_SPLASH",
...
V.yt_vis="isVisible",V.rcl="mwebInfo.responseContentLength",V.GetSettings_rid="requestIds",V.GetTrending_rid="requestIds",V.GetMusicSearchSuggestions_rid="requestIds",V.REQUEST_ID="requestIds",V),tr="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),
ur={},vr=(ur.ccs="CANARY_STATE_",ur.mver="MEASUREMENT_VERSION_",ur.pis="PLAYER_INITIALIZED_STATE_",ur.yt_pt="LATENCY_PLAYER_",ur.pa="LATENCY_ACTION_",ur.ctop="TOP_ENTITY_TYPE_",ur.yt_vst="VIDEO_STREAM_TYPE_",ur),wr="all_vc ap aq c cbr cbrand cbrver cmodel cos cosver cplatform ctheme cver ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function xr(a){return rr[a]||"LATENCY_ACTION_UNKNOWN"}
function yr(a,b,c){c=jr(c);if(c.gelInfos)c.gelInfos[a]=!0;else{var d={};c.gelInfos=(d[a]=!0,d)}if(a.match("_rid")){var e=a.split("_rid")[0];a="REQUEST_ID"}if(a in sr){c=sr[a];0<=db(tr,c)&&(b=!!b);a in vr&&"string"===typeof b&&(b=vr[a]+b.toUpperCase());a=b;b=c.split(".");for(var f=d={},g=0;g<b.length-1;g++){var h=b[g];f[h]={};f=f[h]}f[b[b.length-1]]="requestIds"===c?[{id:a,endpoint:e}]:a;return Sq({},d)}0<=db(wr,a)||Bp(new Q("Unknown label logged with GEL CSI",a))}
...
W[W.LATENCY_ACTION_STARTUP]="LATENCY_ACTION_STARTUP";W[W.LATENCY_ACTION_UNKNOWN]="LATENCY_ACTION_UNKNOWN";var zr={LATENCY_NETWORK_MOBILE:2,LATENCY_NETWORK_WIFI:1,LATENCY_NETWORK_UNKNOWN:0};zr[zr.LATENCY_NETWORK_MOBILE]="LATENCY_NETWORK_MOBILE";zr[zr.LATENCY_NETWORK_WIFI]="LATENCY_NETWORK_WIFI";zr[zr.LATENCY_NETWORK_UNKNOWN]="LATENCY_NETWORK_UNKNOWN";
...
Y[Y.DETAILED_NETWORK_TYPE_1_X_RTT]="DETAILED_NETWORK_TYPE_1_X_RTT";Y[Y.DETAILED_NETWORK_TYPE_GPRS]="DETAILED_NETWORK_TYPE_GPRS";Y[Y.DETAILED_NETWORK_TYPE_EDGE]="DETAILED_NETWORK_TYPE_EDGE";Y[Y.DETAILED_NETWORK_TYPE_UNKNOWN]="DETAILED_NETWORK_TYPE_UNKNOWN";var Ar={LATENCY_PLAYER_RTSP:7,LATENCY_PLAYER_HTML5_INLINE:6,LATENCY_PLAYER_HTML5_FULLSCREEN:5,LATENCY_PLAYER_HTML5:4,LATENCY_PLAYER_FRAMEWORK:3,LATENCY_PLAYER_FLASH:2,LATENCY_PLAYER_EXO:1,LATENCY_PLAYER_UNKNOWN:0};Ar[Ar.LATENCY_PLAYER_RTSP]="LATENCY_PLAYER_RTSP";
Ar[Ar.LATENCY_PLAYER_HTML5_INLINE]="LATENCY_PLAYER_HTML5_INLINE";Ar[Ar.LATENCY_PLAYER_HTML5_FULLSCREEN]="LATENCY_PLAYER_HTML5_FULLSCREEN";Ar[Ar.LATENCY_PLAYER_HTML5]="LATENCY_PLAYER_HTML5";Ar[Ar.LATENCY_PLAYER_FRAMEWORK]="LATENCY_PLAYER_FRAMEWORK";Ar[Ar.LATENCY_PLAYER_FLASH]="LATENCY_PLAYER_FLASH";Ar[Ar.LATENCY_PLAYER_EXO]="LATENCY_PLAYER_EXO";Ar[Ar.LATENCY_PLAYER_UNKNOWN]="LATENCY_PLAYER_UNKNOWN";
var Br={LATENCY_AD_BREAK_TYPE_POSTROLL:3,LATENCY_AD_BREAK_TYPE_MIDROLL:2,LATENCY_AD_BREAK_TYPE_PREROLL:1,LATENCY_AD_BREAK_TYPE_UNKNOWN:0};Br[Br.LATENCY_AD_BREAK_TYPE_POSTROLL]="LATENCY_AD_BREAK_TYPE_POSTROLL";Br[Br.LATENCY_AD_BREAK_TYPE_MIDROLL]="LATENCY_AD_BREAK_TYPE_MIDROLL";Br[Br.LATENCY_AD_BREAK_TYPE_PREROLL]="LATENCY_AD_BREAK_TYPE_PREROLL";Br[Br.LATENCY_AD_BREAK_TYPE_UNKNOWN]="LATENCY_AD_BREAK_TYPE_UNKNOWN";var Cr={LATENCY_ACTION_ERROR_STARTUP_TIMEOUT:1,LATENCY_ACTION_ERROR_UNSPECIFIED:0};
Cr[Cr.LATENCY_ACTION_ERROR_STARTUP_TIMEOUT]="LATENCY_ACTION_ERROR_STARTUP_TIMEOUT";Cr[Cr.LATENCY_ACTION_ERROR_UNSPECIFIED]="LATENCY_ACTION_ERROR_UNSPECIFIED";var Dr={LIVE_STREAM_MODE_WINDOW:5,LIVE_STREAM_MODE_POST:4,LIVE_STREAM_MODE_LP:3,LIVE_STREAM_MODE_LIVE:2,LIVE_STREAM_MODE_DVR:1,LIVE_STREAM_MODE_UNKNOWN:0};Dr[Dr.LIVE_STREAM_MODE_WINDOW]="LIVE_STREAM_MODE_WINDOW";Dr[Dr.LIVE_STREAM_MODE_POST]="LIVE_STREAM_MODE_POST";Dr[Dr.LIVE_STREAM_MODE_LP]="LIVE_STREAM_MODE_LP";
Dr[Dr.LIVE_STREAM_MODE_LIVE]="LIVE_STREAM_MODE_LIVE";Dr[Dr.LIVE_STREAM_MODE_DVR]="LIVE_STREAM_MODE_DVR";Dr[Dr.LIVE_STREAM_MODE_UNKNOWN]="LIVE_STREAM_MODE_UNKNOWN";var Er={VIDEO_STREAM_TYPE_VOD:3,VIDEO_STREAM_TYPE_DVR:2,VIDEO_STREAM_TYPE_LIVE:1,VIDEO_STREAM_TYPE_UNSPECIFIED:0};Er[Er.VIDEO_STREAM_TYPE_VOD]="VIDEO_STREAM_TYPE_VOD";Er[Er.VIDEO_STREAM_TYPE_DVR]="VIDEO_STREAM_TYPE_DVR";Er[Er.VIDEO_STREAM_TYPE_LIVE]="VIDEO_STREAM_TYPE_LIVE";Er[Er.VIDEO_STREAM_TYPE_UNSPECIFIED]="VIDEO_STREAM_TYPE_UNSPECIFIED";
var Fr={YT_IDB_TRANSACTION_TYPE_READ:2,YT_IDB_TRANSACTION_TYPE_WRITE:1,YT_IDB_TRANSACTION_TYPE_UNKNOWN:0};Fr[Fr.YT_IDB_TRANSACTION_TYPE_READ]="YT_IDB_TRANSACTION_TYPE_READ";Fr[Fr.YT_IDB_TRANSACTION_TYPE_WRITE]="YT_IDB_TRANSACTION_TYPE_WRITE";Fr[Fr.YT_IDB_TRANSACTION_TYPE_UNKNOWN]="YT_IDB_TRANSACTION_TYPE_UNKNOWN";var Gr={PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN:2,PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT:1,PLAYER_ROTATION_TYPE_UNKNOWN:0};Gr[Gr.PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN]="PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN";
Gr[Gr.PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT]="PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT";Gr[Gr.PLAYER_ROTATION_TYPE_UNKNOWN]="PLAYER_ROTATION_TYPE_UNKNOWN";var Hr="actionVisualElement spinnerInfo resourceInfo playerInfo commentInfo mdxInfo watchInfo thumbnailLoadInfo creatorInfo unpluggedInfo reelInfo subscriptionsFeedInfo requestIds mediaBrowserActionInfo musicLoadActionInfo shoppingInfo prefetchInfo accelerationSession webInfo tvInfo kabukiInfo mwebInfo musicInfo".split(" ");var Ir=x.ytLoggingLatencyUsageStats_||{};y("ytLoggingLatencyUsageStats_",Ir);function Jr(){this.i=0}
function Kr(){Jr.i||(Jr.i=new Jr);return Jr.i}
Jr.prototype.tick=function(a,b,c,d){Lr(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},M("web_csi_via_jspb")?(d=new uh,D(d,1,a),D(d,2,b),a=new xh,od(a,5,yh,d),np(a,c)):Wj("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
Jr.prototype.info=function(a,b,c){var d=Object.keys(a).join("");Lr(this,"info_"+d+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,Wj("latencyActionInfo",a,{cttAuthInfo:c}))};
Jr.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));Lr(this,"info_"+d+"_"+b)||(D(a,2,b),b={cttAuthInfo:c},c=new xh,od(c,7,yh,a),np(c,b))};
Jr.prototype.span=function(a,b,c){var d=Object.keys(a).join("");Lr(this,"span_"+d+"_"+b)||(a.clientActionNonce=b,Wj("latencyActionSpan",a,{cttAuthInfo:c}))};
function Lr(a,b){Ir[b]=Ir[b]||{count:0};var c=Ir[b];c.count++;c.time=P();a.i||(a.i=Gj(function(){var d=P(),e;for(e in Ir)Ir[e]&&6E4<d-Ir[e].time&&delete Ir[e];a&&(a.i=0)},5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new Q("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||Bp(c)),!0):!1}
;function Mr(){var a=["ol"];qr("").info.actionType="embed";a&&Kh("TIMING_AFT_KEYS",a);Kh("TIMING_ACTION","embed");Nr();a=ir();var b=kr();if("cold"===a.yt_lt||"cold"===b.loadType){var c=dr(),d=jr();d=d.gelTicks?d.gelTicks:d.gelTicks={};for(var e in c)e in d||Z(e,c[e]);e={};c=!1;d=p(Object.keys(a));for(var f=d.next();!f.done;f=d.next())f=f.value,(f=yr(f,a[f]))&&!nr(kr(),f)&&(Sq(b,f),Sq(e,f),c=!0);c&&Or(e)}y("ytglobal.timingready_",!0);a=A("TIMING_ACTION");z("ytglobal.timingready_")&&a&&"_start"in dr()&&
cr()&&mr()}
function Pr(a,b,c,d){null!==b&&(ir(c)[a]=b,(a=yr(a,b,c))&&Or(a,c,d))}
function Or(a,b,c){if(!M("web_csi_via_jspb")||(void 0===c?0:c))c=qr(b||""),Sq(c.info,a),Sq(kr(b),a),c=lr(b),b=hr(b).cttAuthInfo,Kr().info(a,c,b);else{c=new oh;var d=Object.keys(a);a=Object.values(a);for(var e=0;e<d.length;e++){var f=d[e];try{switch(f){case "actionType":qh(c,W[a[e]]);break;case "clientActionNonce":D(c,2,a[e]);break;case "clientScreenNonce":D(c,4,a[e]);break;case "loadType":D(c,3,a[e]);break;case "isPrewarmedLaunch":D(c,92,a[e]);break;case "isFirstInstall":D(c,55,a[e]);break;case "networkType":D(c,
5,zr[a[e]]);break;case "connectionType":D(c,26,X[a[e]]);break;case "detailedConnectionType":D(c,27,Y[a[e]]);break;case "isVisible":D(c,6,a[e]);break;case "playerType":D(c,7,Ar[a[e]]);break;case "clientPlaybackNonce":D(c,8,a[e]);break;case "adClientPlaybackNonce":D(c,28,a[e]);break;case "previousCpn":D(c,77,a[e]);break;case "targetCpn":D(c,76,a[e]);break;case "isMonetized":D(c,9,a[e]);break;case "isPrerollAllowed":D(c,16,a[e]);break;case "isPrerollShown":D(c,17,a[e]);break;case "adType":D(c,12,a[e]);
break;case "adTypesAllowed":D(c,36,a[e]);break;case "adNetworks":D(c,37,a[e]);break;case "previousAction":D(c,13,W[a[e]]);break;case "isRedSubscriber":D(c,14,a[e]);break;case "serverTimeMs":D(c,15,a[e]);break;case "videoId":c.setVideoId(a[e]);break;case "adVideoId":D(c,20,a[e]);break;case "targetVideoId":D(c,78,a[e]);break;case "adBreakType":D(c,21,Br[a[e]]);break;case "isNavigation":rh(c,a[e]);break;case "viewportHeight":D(c,29,a[e]);break;case "viewportWidth":D(c,30,a[e]);break;case "screenHeight":D(c,
...
case "appInstallDataAgeMs":D(c,73,a[e]);break;case "latencyActionError":D(c,71,Cr[a[e]]);break;case "actionStep":D(c,79,a[e]);break;case "jsHeapSizeLimit":D(c,80,a[e]);break;case "totalJsHeapSize":D(c,81,a[e]);break;case "usedJsHeapSize":D(c,82,a[e]);break;case "sourceVideoDurationMs":D(c,90,a[e]);break;case "adPrebufferedTimeSecs":D(c,39,a[e]);break;case "isLivestream":D(c,47,a[e]);break;case "liveStreamMode":D(c,91,Dr[a[e]]);break;case "adCpn2":D(c,48,a[e]);break;case "adDaiDriftMillis":D(c,49,
a[e]);break;case "videoStreamType":D(c,53,Er[a[e]]);break;case "playbackRequiresTap":D(c,56,a[e]);break;case "performanceNavigationTiming":D(c,67,a[e]);break;case "transactionType":D(c,74,Fr[a[e]]);break;case "playerRotationType":D(c,101,Gr[a[e]]);break;case "allowedPreroll":D(c,10,a[e]);break;case "shownPreroll":D(c,11,a[e]);break;case "getHomeRequestId":D(c,57,a[e]);break;case "getSearchRequestId":D(c,60,a[e]);break;case "getPlayerRequestId":D(c,61,a[e]);break;case "getWatchNextRequestId":D(c,62,
a[e]);break;case "getBrowseRequestId":D(c,63,a[e]);break;case "getLibraryRequestId":D(c,66,a[e]);break;default:Hr.includes(f)&&Th(new Q("Codegen laipb translator asked to translate message field",""+f))}}catch(g){Th(Error("Codegen laipb translator failed to set "+f))}}Qr(c,b)}}
function Qr(a,b){var c=jr(b);c.jspbInfos||(c.jspbInfos=[]);c.jspbInfos.push(a);qr(b||"").jspbInfo.push(a);c=lr(b);b=hr(b).cttAuthInfo;Kr().jspbInfo(a,c,b)}
function Z(a,b,c){if(!b&&"_"!==a[0]){var d=a;T.mark&&(0==d.lastIndexOf("mark_",0)||(d="mark_"+d),c&&(d+=" ("+c+")"),T.mark(d))}qr(c||"").tick[a]=b||P();d=jr(c);d.gelTicks&&(d.gelTicks[a]=!0);d=dr(c);var e=b||P();d[a]=e;e=lr(c);var f=hr(c).cttAuthInfo;if("_start"===a){var g=Kr();Lr(g,"baseline_"+e)||(b={timestamp:b,cttAuthInfo:f},M("web_csi_via_jspb")?(f=new mh,D(f,1,e),e=new xh,od(e,6,yh,f),np(e,b)):Wj("latencyActionBaselined",{clientActionNonce:e},b))}else Kr().tick(a,e,b,f);mr(c);return d[a]}
function Rr(){var a=lr();requestAnimationFrame(function(){setTimeout(function(){a===lr()&&Z("ol",void 0,void 0)},0)})}
function Sr(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=en+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
function Nr(){function a(f){var g=er(),h=gr();h&&(Z("srt",g.responseStart),1!==f.prerender&&Z("_start",h,void 0));f=or();0<f&&Z("fpt",f);f=er();f.isPerformanceNavigationTiming&&Or({performanceNavigationTiming:!0});Z("nreqs",f.requestStart,void 0);Z("nress",f.responseStart,void 0);Z("nrese",f.responseEnd,void 0);0<f.redirectEnd-f.redirectStart&&(Z("nrs",f.redirectStart,void 0),Z("nre",f.redirectEnd,void 0));0<f.domainLookupEnd-f.domainLookupStart&&(Z("ndnss",f.domainLookupStart,void 0),Z("ndnse",f.domainLookupEnd,
void 0));0<f.connectEnd-f.connectStart&&(Z("ntcps",f.connectStart,void 0),Z("ntcpe",f.connectEnd,void 0));f.secureConnectionStart>=gr()&&0<f.connectEnd-f.secureConnectionStart&&(Z("nstcps",f.secureConnectionStart,void 0),Z("ntcpe",f.connectEnd,void 0));T&&"getEntriesByType"in T&&Tr()}
var b=A("TIMING_INFO",{});if(M("web_csi_via_jspb")){b=Ur(b);Qr(b);b=qh(rh(new oh,!0),W[xr(A("TIMING_ACTION"))]);var c=A("PREVIOUS_ACTION");c&&D(b,13,W[xr(c)]);(c=A("CLIENT_PROTOCOL"))&&D(b,33,c);(c=A("CLIENT_TRANSPORT"))&&D(b,34,c);(c=Tp())&&"UNDEFINED_CSN"!==c&&D(b,4,c);c=Sr();1!==c&&-1!==c||D(b,6,!0);c=ir();D(b,3,"cold");a(c);c=Vr();if(0<c.length){c=p(c);for(var d=c.next();!d.done;d=c.next()){d=d.value;var e=new nh;D(e,1,d);pd(b,83,nh,e)}}Qr(b)}else{for(c in b)b.hasOwnProperty(c)&&Pr(c,b[c]);b=
{isNavigation:!0,actionType:xr(A("TIMING_ACTION"))};if(c=A("PREVIOUS_ACTION"))b.previousAction=xr(c);if(c=A("CLIENT_PROTOCOL"))b.httpProtocol=c;if(c=A("CLIENT_TRANSPORT"))b.transportProtocol=c;(c=Tp())&&"UNDEFINED_CSN"!==c&&(b.clientScreenNonce=c);c=Sr();if(1===c||-1===c)b.isVisible=!0;c=ir();b.loadType="cold";a(c);c=Vr();if(0<c.length)for(b.resourceInfo=[],c=p(c),d=c.next();!d.done;d=c.next())b.resourceInfo.push({resourceCache:d.value});Or(b)}}
function Ur(a){var b=new oh;a=p(Object.entries(a));for(var c=a.next();!c.done;c=a.next()){var d=p(c.value);c=d.next().value;d=d.next().value;switch(c){case "GetBrowse_rid":var e=new th;D(e,1,c);D(e,2,String(d));sh(b,e);break;case "GetGuide_rid":e=new th;D(e,1,c);D(e,2,String(d));sh(b,e);break;case "GetHome_rid":e=new th;D(e,1,c);D(e,2,String(d));sh(b,e);break;case "GetPlayer_rid":e=new th;D(e,1,c);D(e,2,String(d));sh(b,e);break;case "GetSearch_rid":e=new th;D(e,1,c);D(e,2,String(d));sh(b,e);break;
...
function Wr(a,b){a=document.querySelector(a);if(!a)return!1;var c="",d=a.nodeName;"SCRIPT"===d?(c=a.src,c||(c=a.getAttribute("data-timing-href"))&&(c=window.location.protocol+c)):"LINK"===d&&(c=a.href);Xb()&&a.setAttribute("nonce",Xb());return c?(a=T.getEntriesByName(c))&&a[0]&&(a=a[0],c=gr(),Z("rsf_"+b,c+Math.round(a.fetchStart)),Z("rse_"+b,c+Math.round(a.responseEnd)),void 0!==a.transferSize&&0===a.transferSize)?!0:!1:!1}
function Vr(){var a=[];if(document.querySelector&&T&&T.getEntriesByName)for(var b in br)if(br.hasOwnProperty(b)){var c=br[b];Wr(b,c)&&a.push(c)}return a}
function Tr(){var a=window.location.protocol,b=T.getEntriesByType("resource");b=fb(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
(b=hb(b,function(c,d){return d.duration>c.duration?d:c},{duration:0}))&&0<b.startTime&&0<b.responseEnd&&(Z("wffs",fr(b.startTime)),Z("wffe",fr(b.responseEnd)))}
var Xr=window;Xr.ytcsi&&(Xr.ytcsi.info=Pr,Xr.ytcsi.tick=Z);var Yr="tokens consistency mss client_location entities store".split(" ");function Zr(a,b,c,d){this.s=a;this.K=b;this.m=c;this.l=d;this.j=void 0;this.i=new Map;a.Aa||(a.Aa={});a.Aa=Object.assign({},Rq,a.Aa)}
function $r(a,b,c,d){if(void 0!==Zr.i){if(d=Zr.i,a=[a!==d.s,b!==d.K,c!==d.m,!1,!1,void 0!==d.j],a.some(function(e){return e}))throw new Q("InnerTubeTransportService is already initialized",a);
}else Zr.i=new Zr(a,b,c,d)}
function as(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?zq:c;var d=Iq(b,a.s);if(!d)return Yf(new Q("Error: No request builder found for command.",b));var e=d.s(b,void 0,c);return e?new Tf(function(f){var g,h,k;return w(function(m){if(1==m.i){h="cors"===(null==(g=e.sa)?void 0:g.mode)?"cors":void 0;if(a.m.zc){var q=e.config,u;q=null==q?void 0:null==(u=q.Ha)?void 0:u.sessionIndex;u=qq({sessionIndex:q});k=Object.assign({},bs(h),u);return m.u(2)}return t(m,cs(e.config,
h),3)}2!=m.i&&(k=m.j);f(ds(a,e,k));m.i=0})}):Yf(new Q("Error: Failed to build request for command.",b))}
function ds(a,b,c){var d,e,f,g,h,k,m,q,u,B,v,E,F,H,R,O,S,ja;return w(function(N){switch(N.i){case 1:N.u(2);break;case 3:if((d=N.j)&&!d.isExpired())return N.return(Promise.resolve(d.i()));case 2:if((f=null==(e=b.config)?void 0:e.hp)&&a.i.has(f)&&M("web_memoize_inflight_requests"))return N.return(a.i.get(f));if(null==(g=b)?0:null==(h=g.ca)?0:h.context)for(k=p([]),m=k.next();!m.done;m=k.next())q=m.value,q.fp(b.ca.context);if(null==(u=a.j)?0:u.m(b.input,b.ca))return N.return(a.j.l(b.input,b.ca));B=JSON.stringify(b.ca);
b.sa=Object.assign({},b.sa,{headers:c});v=Object.assign({},b.sa);"POST"===b.sa.method&&(v=Object.assign({},v,{body:B}));(null==(E=b.config)?0:E.kc)&&Z(b.config.kc);F=a.K.fetch(b.input,v,b.config);f&&a.i.set(f,F);return t(N,F,4);case 4:H=N.j;f&&a.i.has(f)&&a.i.delete(f);(null==(R=b.config)?0:R.lc)&&Z(b.config.lc);if(H||null==(O=a.j)||!O.i(b.input,b.ca)){N.u(5);break}return t(N,a.j.j(b.input,b.ca),6);case 6:H=N.j;case 5:if(H&&a.l)for(S=p(Yr),m=S.next();!m.done;m=S.next())ja=m.value,a.l[ja]&&a.l[ja].handleResponse(H,
b);return N.return(H)}})}
function cs(a,b){var c,d,e,f;return w(function(g){if(1==g.i){e=null==(c=a)?void 0:null==(d=c.Ha)?void 0:d.sessionIndex;var h=qq({sessionIndex:e});if(!(h instanceof Tf)){var k=new Tf(bb);Uf(k,2,h);h=k}return t(g,h,2)}f=g.j;return g.return(Promise.resolve(Object.assign({},bs(b),f)))})}
function bs(a){var b={"Content-Type":"application/json"};M("enable_web_eom_visitor_data")&&A("EOM_VISITOR_DATA")?b["X-Goog-EOM-Visitor-Id"]=A("EOM_VISITOR_DATA"):A("VISITOR_DATA")&&(b["X-Goog-Visitor-Id"]=A("VISITOR_DATA"));M("track_webfe_innertube_auth_mismatch")&&(b["X-Youtube-Bootstrap-Logged-In"]=A("LOGGED_IN",!1));"cors"!==a&&((a=A("INNERTUBE_CONTEXT_CLIENT_NAME"))&&(b["X-Youtube-Client-Name"]=a),(a=A("INNERTUBE_CONTEXT_CLIENT_VERSION"))&&(b["X-Youtube-Client-Version"]=a),(a=A("CHROME_CONNECTED_HEADER"))&&
...
;var es=["share/get_web_player_share_panel"],fs=["feedback"],gs=["notification/modify_channel_preference"],hs=["browse/edit_playlist"],is=["subscription/subscribe"],js=["subscription/unsubscribe"];function ks(){}
r(ks,Oq);ks.prototype.l=function(){return is};
ks.prototype.i=function(a){return a.subscribeEndpoint};
ks.prototype.j=function(a,b,c){c=void 0===c?{}:c;b.channelIds&&(a.channelIds=b.channelIds);b.siloName&&(a.siloName=b.siloName);b.params&&(a.params=b.params);c.botguardResponse&&(a.botguardResponse=c.botguardResponse);c.feature&&(a.clientFeature=c.feature)};
da.Object.defineProperties(ks.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!0}}});function ls(){}
r(ls,Oq);ls.prototype.l=function(){return js};
ls.prototype.i=function(a){return a.unsubscribeEndpoint};
ls.prototype.j=function(a,b){b.channelIds&&(a.channelIds=b.channelIds);b.siloName&&(a.siloName=b.siloName);b.params&&(a.params=b.params)};
da.Object.defineProperties(ls.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!0}}});function ms(){}
r(ms,Oq);ms.prototype.l=function(){return fs};
ms.prototype.i=function(a){return a.feedbackEndpoint};
ms.prototype.j=function(a,b,c){a.feedbackTokens=[];b.feedbackToken&&a.feedbackTokens.push(b.feedbackToken);if(b=b.cpn||c.cpn)a.feedbackContext={cpn:b};a.isFeedbackTokenUnencrypted=!!c.is_feedback_token_unencrypted;a.shouldMerge=!1;c.extra_feedback_tokens&&(a.shouldMerge=!0,a.feedbackTokens=a.feedbackTokens.concat(c.extra_feedback_tokens))};
da.Object.defineProperties(ms.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!0}}});function ns(){}
r(ns,Oq);ns.prototype.l=function(){return gs};
ns.prototype.i=function(a){return a.modifyChannelNotificationPreferenceEndpoint};
ns.prototype.j=function(a,b){b.params&&(a.params=b.params);b.secondaryParams&&(a.secondaryParams=b.secondaryParams)};function os(){}
r(os,Oq);os.prototype.l=function(){return hs};
os.prototype.i=function(a){return a.playlistEditEndpoint};
os.prototype.j=function(a,b){b.actions&&(a.actions=b.actions);b.params&&(a.params=b.params);b.playlistId&&(a.playlistId=b.playlistId)};function ps(){}
r(ps,Oq);ps.prototype.l=function(){return es};
ps.prototype.i=function(a){return a.webPlayerShareEntityServiceEndpoint};
ps.prototype.j=function(a,b,c){c=void 0===c?{}:c;b.serializedShareEntity&&(a.serializedSharedEntity=b.serializedShareEntity);c.includeListId&&(a.includeListId=!0)};var uq=new sq("NETWORK_SLI_TOKEN");function qs(a){this.i=a}
qs.prototype.fetch=function(a,b){var c=this,d,e;return w(function(f){c.i&&(d=ac(bc(5,nc(a)))||"/UNKNOWN_PATH",c.i.start(d));e=new window.Request(a,b);return M("web_fetch_promise_cleanup_killswitch")?f.return(Promise.resolve(fetch(e).then(function(g){return c.handleResponse(g)}).catch(function(g){Bp(g)}))):f.return(fetch(e).then(function(g){return c.handleResponse(g)}).catch(function(g){Bp(g)}))})};
qs.prototype.handleResponse=function(a){var b=a.text().then(function(c){return JSON.parse(c.replace(")]}'",""))});
a.redirected||a.ok?this.i&&this.i.success():(this.i&&this.i.failure(),b=b.then(function(c){Bp(new Q("Error: API fetch failed",a.status,a.url,c));return Object.assign({},c,{errorMetadata:{status:a.status}})}));
return b};
qs[rq]=[new tq];var rs=new sq("NETWORK_MANAGER_TOKEN");var ss;function ts(a){Dl.call(this,1,arguments);this.csn=a}
r(ts,Dl);var Ml=new El("screen-created",ts),us=[],ws=vs,xs=0;function ys(a,b,c,d,e,f,g){function h(){Bp(new Q("newScreen() parent element does not have a VE - rootVe",b))}
var k=ws();f=new Mp({veType:b,youtubeData:f,jspbYoutubeData:void 0});e={cttAuthInfo:e,Y:k};if(M("il_via_jspb")){var m=new ch;m.T(k);dh(m,f.getAsJspb());c&&c.visualElement?(f=new eh,c.clientScreenNonce&&D(f,2,c.clientScreenNonce),fh(f,c.visualElement.getAsJspb()),g&&D(f,4,zh[g]),I(m,5,f)):c&&h();d&&D(m,3,d);rp(m,e,a)}else f={csn:k,pageVe:f.getAsJson()},c&&c.visualElement?(f.implicitGesture={parentCsn:c.clientScreenNonce,gesturedVe:c.visualElement.getAsJson()},g&&(f.implicitGesture.gestureType=g)):
c&&h(),d&&(f.cloneCsn=d),a?Xo("screenCreated",f,a,e):Wj("screenCreated",f,e);Jl(Ml,new ts(k));return k}
function zs(a,b,c,d){var e=d.filter(function(k){k.csn!==b?(k.csn=b,k=!0):k=!1;return k}),f={cttAuthInfo:Vp(b),
Y:b};d=p(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(ob(g)||!g.trackingParams&&!g.veType)&&Bp(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=new gh;h.T(b);ih(h,c.getAsJspb());gb(e,function(k){k=k.getAsJspb();pd(h,3,ah,k)});
"UNDEFINED_CSN"==b?As("visualElementAttached",h,f):sp(h,f,a)}else c={csn:b,parentVe:c.getAsJson(),childVes:gb(e,function(k){return k.getAsJson()})},"UNDEFINED_CSN"==b?As("visualElementAttached",c,f):a?Xo("visualElementAttached",c,a,f):Wj("visualElementAttached",c,f)}
function vs(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return Kc(b,3)}
function As(a,b,c){us.push({payloadName:a,payload:b,options:c});xs||(xs=Nl())}
function Ol(a){if(us){for(var b=p(us),c=b.next();!c.done;c=b.next()){var d=c.value;if(d.payload)if(M("il_via_jspb"))switch(d.payload.T(a.csn),d.payloadName){case "screenCreated":rp(d.payload,d.options);break;case "visualElementAttached":sp(d.payload,d.options);break;case "visualElementShown":c=d.payload;d=d.options;var e=new xh;od(e,72,yh,c);np(e,d);break;case "visualElementHidden":op(d.payload,d.options);break;case "visualElementGestured":pp(d.payload,d.options);break;case "visualElementStateChanged":qp(d.payload,
d.options);break;default:Bp(new Q("flushQueue unable to map payloadName to JSPB setter"))}else d.payload.csn=a.csn,Xo(d.payloadName,d.payload,null,d.options)}us.length=0}xs=0}
;function Bs(){this.j=new Set;this.i=new Set;this.l=new Map}
Bs.prototype.clear=function(){this.j.clear();this.i.clear();this.l.clear()};
Ma(Bs);function Cs(){this.s=[];this.D=[];this.i=[];this.m=[];this.o=[];this.j=new Set;this.v=new Map}
function Ds(a,b,c){c=void 0===c?0:c;b.then(function(d){a.j.has(c)&&a.l&&a.l();var e=Tp(c),f=Rp(c);if(e&&f){var g;(null==d?0:null==(g=d.response)?0:g.trackingParams)&&zs(a.client,e,f,[Np(d.response.trackingParams)]);var h;(null==d?0:null==(h=d.playerResponse)?0:h.trackingParams)&&zs(a.client,e,f,[Np(d.playerResponse.trackingParams)])}})}
function Es(a,b,c,d){d=void 0===d?0:d;if(a.j.has(d))a.s.push([b,c]);else{var e=Tp(d);c=c||Rp(d);e&&c&&zs(a.client,e,c,[b])}}
Cs.prototype.clickCommand=function(a,b,c){var d=a.clickTrackingParams;c=void 0===c?0:c;if(d)if(c=Tp(void 0===c?0:c)){a=this.client;var e=Np(d);var f="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";d={cttAuthInfo:Vp(c),Y:c};if(M("il_via_jspb")){var g=new jh;g.T(c);e=e.getAsJspb();I(g,2,e);D(g,4,zh[f]);b&&I(g,3);"UNDEFINED_CSN"==c?As("visualElementGestured",g,d):pp(g,d,a)}else f={csn:c,ve:e.getAsJson(),gestureType:f},b&&(f.clientData=b),"UNDEFINED_CSN"==c?As("visualElementGestured",f,d):a?Xo("visualElementGestured",
f,a,d):Wj("visualElementGestured",f,d);b=!0}else b=!1;else b=!1;return b};
function Fs(a,b,c){c=void 0===c?{}:c;a.j.add(c.layer||0);a.l=function(){Gs(a,b,c);var f=Rp(c.layer);if(f){for(var g=p(a.s),h=g.next();!h.done;h=g.next())h=h.value,Es(a,h[0],h[1]||f,c.layer);f=p(a.D);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=Tp(g);var m=k[0]||Rp(g);if(h&&m){g=a.client;var q=k[1];k={cttAuthInfo:Vp(h),Y:h};M("il_via_jspb")?(q=new lh,q.T(h),m=m.getAsJspb(),I(q,2,m),"UNDEFINED_CSN"==h?As("visualElementStateChanged",q,k):qp(q,k,g)):(m={csn:h,ve:m.getAsJson(),
clientData:q},"UNDEFINED_CSN"==h?As("visualElementStateChanged",m,k):g?Xo("visualElementStateChanged",m,g,k):Wj("visualElementStateChanged",m,k))}}}};
Tp(c.layer)||a.l();if(c.rb)for(var d=p(c.rb),e=d.next();!e.done;e=d.next())Ds(a,e.value,c.layer);else Ap(Error("Delayed screen needs a data promise."))}
function Gs(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.ec?c.ec:c.layer;var e=Tp(d);d=Rp(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=A("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=ys(a.client,b,f,c.qb,c.cttAuthInfo,g,c.bp)}catch(m){Dp(m,{ip:b,rootVe:d,parentVisualElement:void 0,Zo:e,ep:f,qb:c.qb});Ap(m);return}Wp(k,b,
c.layer,c.cttAuthInfo);if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=p(Object.values(Lp));for(f=b.next();!f.done;f=b.next())if(Tp(f.value)===e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:Vp(e),Y:e,tb:g},M("il_via_jspb")?(h=new kh,h.T(e),d=d.getAsJspb(),I(h,2,d),D(h,4,g?16:8),"UNDEFINED_CSN"==e?As("visualElementHidden",h,f):op(h,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"==e?As("visualElementHidden",d,f):b?Xo("visualElementHidden",d,b,f):Wj("visualElementHidden",
d,f)));a.i[a.i.length-1]&&!a.i[a.i.length-1].csn&&(a.i[a.i.length-1].csn=k||"");Or({clientScreenNonce:k});Bs.getInstance().clear();d=Rp(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(M("web_mark_root_visible")||M("music_web_mark_root_visible"))&&(e={cttAuthInfo:Vp(k),Y:k},M("il_via_jspb")?(b=new kh,b.T(k),f=d.getAsJspb(),I(b,2,f),D(b,4,1),"UNDEFINED_CSN"==k?As("visualElementShown",b,e):(k=new xh,od(k,72,yh,b),np(k,e))):(b={csn:k,ve:d.getAsJson(),eventType:1},"UNDEFINED_CSN"==k?As("visualElementShown",b,e):
Wj("visualElementShown",b,e)));a.j.delete(c.layer||0);a.l=void 0;e=p(a.v);for(k=e.next();!k.done;k=e.next())b=p(k.value),k=b.next().value,b=b.next().value,b.has(c.layer)&&d&&Es(a,k,d,c.layer);for(c=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(m){Ap(m)}}for(c=a.m.length=0;c<a.o.length;c++){e=a.o[c];try{e()}catch(m){Ap(m)}}}
;function Hs(){var a,b;return w(function(c){if(1==c.i)return a=Zr.i,a?t(c,as(a),2):(Bp(Error("InnertubeTransportService unavailable in fetchDatasyncIds")),c.return(void 0));if(b=c.j)return b.errorMetadata?(Ap(Error("Datasync IDs fetch responded with "+b.errorMetadata.status+": "+b.error)),c.return(void 0)):c.return(b.ap);Bp(Error("Network request to get Datasync IDs failed."));return c.return(void 0)})}
;var Is=x.caches,Js;function Ks(a){var b=a.indexOf(":");return-1===b?{Cb:a}:{Cb:a.substring(0,b),datasyncId:a.substring(b+1)}}
function Ls(){return w(function(a){if(void 0!==Js)return a.return(Js);Js=new Promise(function(b){var c;return w(function(d){switch(d.i){case 1:return wa(d,2),t(d,Is.open("test-only"),4);case 4:return t(d,Is.delete("test-only"),5);case 5:xa(d,3);break;case 2:if(c=ya(d),c instanceof Error&&"SecurityError"===c.name)return b(!1),d.return();case 3:b("caches"in window),d.i=0}})});
return a.return(Js)})}
function Ms(a){var b,c,d,e,f,g,h;w(function(k){if(1==k.i)return t(k,Ls(),2);if(3!=k.i){if(!k.j)return k.return(!1);b=[];return t(k,Is.keys(),3)}c=k.j;d=p(c);for(e=d.next();!e.done;e=d.next())f=e.value,g=Ks(f),h=g.datasyncId,!h||a.includes(h)||b.push(Is.delete(f));return k.return(Promise.all(b).then(function(m){return m.some(function(q){return q})}))})}
function Ns(){var a,b,c,d,e,f,g;return w(function(h){if(1==h.i)return t(h,Ls(),2);if(3!=h.i){if(!h.j)return h.return(!1);a=ak("cache contains other");return t(h,Is.keys(),3)}b=h.j;c=p(b);for(d=c.next();!d.done;d=c.next())if(e=d.value,f=Ks(e),(g=f.datasyncId)&&g!==a)return h.return(!0);return h.return(!1)})}
;function Os(){try{return!!self.localStorage}catch(a){return!1}}
;function Ps(a){a=a.match(/(.*)::.*::.*/);if(null!==a)return a[1]}
function Qs(a){if(Os()){var b=Object.keys(window.localStorage);b=p(b);for(var c=b.next();!c.done;c=b.next()){c=c.value;var d=Ps(c);void 0===d||a.includes(d)||self.localStorage.removeItem(c)}}}
function Rs(){if(!Os())return!1;var a=ak(),b=Object.keys(window.localStorage);b=p(b);for(var c=b.next();!c.done;c=b.next())if(c=Ps(c.value),void 0!==c&&c!==a)return!0;return!1}
;function Ss(){Hs().then(function(a){a&&(ll(a),Ms(a),Qs(a))})}
function Ts(){var a=new ym;$e.O(function(){var b,c,d,e;return w(function(f){switch(f.i){case 1:if(M("ytidb_clear_optimizations_killswitch")){f.u(2);break}b=ak("clear");if(b.startsWith("V")){var g=[b];ll(g);Ms(g);Qs(g);return f.return()}c=Rs();return t(f,Ns(),3);case 3:return d=f.j,t(f,ml(),4);case 4:if(e=f.j,!c&&!d&&!e)return f.return();case 2:a.I()?Ss():a.m.add("publicytnetworkstatus-online",Ss,!0,void 0,void 0),f.i=0}})})}
;function Us(a){a&&(a.dataset?a.dataset[Vs("loaded")]="true":a.setAttribute("data-loaded","true"))}
function Ws(a,b){return a?a.dataset?a.dataset[Vs(b)]:a.getAttribute("data-"+b):null}
var Xs={};function Vs(a){return Xs[a]||(Xs[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var Ys=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,Zs=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function $s(a,b,c){c=void 0===c?null:c;if(window.spf&&spf.script){c="";if(a){var d=a.indexOf("jsbin/"),e=a.lastIndexOf(".js"),f=d+6;-1<d&&-1<e&&e>f&&(c=a.substring(f,e),c=c.replace(Ys,""),c=c.replace(Zs,""),c=c.replace("debug-",""),c=c.replace("tracing-",""))}spf.script.load(a,c,b)}else at(a,b,c)}
function at(a,b,c){c=void 0===c?null:c;var d=bt(a),e=document.getElementById(d),f=e&&Ws(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=zn(d,b),b=""+Ra(b),ct[b]=f),g||(e=dt(a,d,function(){Ws(e,"loaded")||(Us(e),Cn(d),mi(Xa(Dn,d),0))},c)))}
function dt(a,b,c,d){d=void 0===d?null:d;var e=Kd("SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function et(a){a=bt(a);var b=document.getElementById(a);b&&(Dn(a),b.parentNode.removeChild(b))}
function ft(a,b){a&&b&&(a=""+Ra(b),(a=ct[a])&&Bn(a))}
function bt(a){var b=document.createElement("a");Ub(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Zb(a)}
var ct={};var gt=[],ht=!1;function jt(){if(!M("disable_biscotti_fetch_for_ad_blocker_detection")&&!M("disable_biscotti_fetch_entirely_for_all_web_clients")&&gq()&&"1"!=sb()){var a=function(){ht=!0;"google_ad_status"in window?Kh("DCLKSTAT",1):Kh("DCLKSTAT",2)};
try{$s("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}gt.push($e.O(function(){if(!(ht||"google_ad_status"in window)){try{ft("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}ht=!0;Kh("DCLKSTAT",3)}},5E3))}}
function mt(){var a=Number(A("DCLKSTAT",0));return isNaN(a)?0:a}
;function nt(){this.state=1;this.i=null}
l=nt.prototype;
l.initialize=function(a,b,c){if(a.program){var d,e=null!=(d=a.interpreterScript)?d:null,f;d=null!=(f=a.interpreterUrl)?f:null;a.interpreterSafeScript&&(e=a.interpreterSafeScript,Cb("From proto message. b/166824318"),e=e.privateDoNotAccessOrElseSafeScriptWrappedValue||"",e=(f=zb())?f.createScript(e):e,e=(new Eb(e)).toString());a.interpreterSafeUrl&&(d=a.interpreterSafeUrl,Cb("From proto message. b/166824318"),d=Ib(d.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue||"").toString());ot(this,e,
d,a.program,b,c)}else Bp(Error("Cannot initialize botguard without program"))};
function ot(a,b,c,d,e,f){var g=void 0===g?"trayride":g;c?(a.state=2,$s(c,function(){window[g]?pt(a,d,g,e):(a.state=3,et(c),Bp(new Q("Unable to load Botguard","from "+c)))},f)):b?(f=Kd("SCRIPT"),f.textContent=b,f.nonce=Xb(),document.head.appendChild(f),document.head.removeChild(f),window[g]?pt(a,d,g,e):(a.state=4,Bp(new Q("Unable to load Botguard from JS")))):Bp(new Q("Unable to load VM; no url or JS provided"))}
l.isInitialized=function(){return!!this.i};
l.getState=function(){return this.state};
function pt(a,b,c,d){a.state=5;try{var e=new zd({program:b,globalName:c});e.wc.then(function(){a.state=6;d&&d(b)});
qt(a,e)}catch(f){a.state=7,f instanceof Error&&Bp(f)}}
...
l.dispose=function(){qt(this,null);this.state=8};
function qt(a,b){ne(a.i);a.i=b}
;var rt=new nt;function st(){return rt.isInitialized()}
function tt(a){a=void 0===a?{}:a;return rt.invoke(a)}
...
e=Hj(d,vt(this,a.ta));this.i[a.Ca]=Object.assign({},a.ta,{eb:d,Oa:e})}}
function wt(a){var b=Array.from(a.i.keys()).sort(function(d,e){return vt(a,a.i[e])-vt(a,a.i[d])});
b=p(b);for(var c=b.next();!c.done;c=b.next())c=a.i[c.value],void 0===c.Oa||c.Sa||(a.l.V(c.Oa),Hj(c.eb,10))}
ut.prototype.cancel=function(){for(var a=p(this.i),b=a.next();!b.done;b=a.next())b=b.value,void 0===b.Oa||b.Sa||this.l.V(b.Oa),b.Sa=!0;this.j.resolve()};
function vt(a,b){var c;return null!=(c=b.priority)?c:a.m}
;function xt(a){this.state=a;this.plugins=[];this.o=void 0}
xt.prototype.install=function(){this.plugins.push.apply(this.plugins,fa(Ja.apply(0,arguments)))};
xt.prototype.transition=function(a,b){var c=this,d=this.D.find(function(f){return f.from===c.state&&f.C===a});
if(d){this.l&&(wt(this.l),this.l=void 0);this.state=a;d=d.action.bind(this);var e=this.plugins.filter(function(f){return f[a]}).map(function(f){return f[a]});
d(zt(this,e,this.o),b)}else throw Error("no transition specified from "+this.state+" to "+a);};
function zt(a,b,c){return function(){var d=Ja.apply(0,arguments),e=b.filter(function(k){var m;return 10===(null!=(m=null!=c?c:k.priority)?m:0)}),f=b.filter(function(k){var m;
...
r(Bt,xt);Bt.prototype.j=function(a,b){a(null==b?void 0:b.event);M("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_foregrounded")};
Bt.prototype.i=function(a,b){a(null==b?void 0:b.event);M("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_backgrounded")};
Bt.prototype.m=function(a,b){a(null==b?void 0:b.event)};
Bt.prototype.s=function(a,b){a(null==b?void 0:b.event)};function Ct(){this.i=new At;this.j=new Bt}
Ct.prototype.install=function(){var a=Ja.apply(0,arguments);this.i.install.apply(this.i,fa(a));this.j.install.apply(this.j,fa(a))};function Dt(){Ct.call(this);var a={};this.install((a.document_disposed={la:this.l},a));a={};this.install((a.flush_logs={la:this.m},a))}
var Et;r(Dt,Ct);Dt.prototype.m=function(){if(M("web_fp_via_jspb")){var a=new $g,b=Tp();b&&a.T(b);b=new xh;od(b,380,yh,a);np(b);M("web_fp_via_jspb_and_json")&&Wj("finalPayload",{csn:Tp()})}else Wj("finalPayload",{csn:Tp()})};
Dt.prototype.l=function(){Fp(Gp)};function Ft(){}
Ft.getInstance=function(){var a=z("ytglobal.storage_");a||(a=new Ft,y("ytglobal.storage_",a));return a};
Ft.prototype.estimate=function(){var a,b,c;return w(function(d){a=navigator;return(null==(b=a.storage)?0:b.estimate)?d.return(a.storage.estimate()):(null==(c=a.webkitTemporaryStorage)?0:c.queryUsageAndQuota)?d.return(Gt()):d.return()})};
function Gt(){var a=navigator;return new Promise(function(b,c){var d;null!=(d=a.webkitTemporaryStorage)&&d.queryUsageAndQuota?a.webkitTemporaryStorage.queryUsageAndQuota(function(e,f){b({usage:e,quota:f})},function(e){c(e)}):c(Error("webkitTemporaryStorage is not supported."))})}
y("ytglobal.storageClass_",Ft);function Uj(a,b){var c=this;this.handleError=a;this.i=b;this.j=!1;void 0===self.document||self.addEventListener("beforeunload",function(){c.j=!0});
this.l=Math.random()<=Nh("ytidb_transaction_ended_event_rate_limit",.02)}
Uj.prototype.logEvent=function(a,b){switch(a){case "IDB_DATA_CORRUPTED":M("idb_data_corrupted_killswitch")||this.i("idbDataCorrupted",b);break;case "IDB_UNEXPECTEDLY_CLOSED":this.i("idbUnexpectedlyClosed",b);break;case "IS_SUPPORTED_COMPLETED":M("idb_is_supported_completed_killswitch")||this.i("idbIsSupportedCompleted",b);break;case "QUOTA_EXCEEDED":Ht(this,b);break;case "TRANSACTION_ENDED":this.l&&this.i("idbTransactionEnded",b);break;case "TRANSACTION_UNEXPECTEDLY_ABORTED":a=Object.assign({},b,
{hasWindowUnloaded:this.j}),this.i("idbTransactionAborted",a)}};
function Ht(a,b){Ft.getInstance().estimate().then(function(c){c=Object.assign({},b,{isSw:void 0===self.document,isIframe:self!==self.top,deviceStorageUsageMbytes:It(null==c?void 0:c.usage),deviceStorageQuotaMbytes:It(null==c?void 0:c.quota)});a.i("idbQuotaExceeded",c)})}
function It(a){return"undefined"===typeof a?"-1":String(Math.ceil(a/1048576))}
;function Jt(a,b,c){K.call(this);var d=this;c=c||A("POST_MESSAGE_ORIGIN")||window.document.location.protocol+"//"+window.document.location.hostname;this.l=b||null;this.M="*";this.m=c;this.sessionId=null;this.channel="widget";this.N=!!a;this.B=function(e){a:if(!("*"!=d.m&&e.origin!=d.m||d.l&&e.source!=d.l||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.N&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
r(Jt,K);Jt.prototype.sendMessage=function(a,b){if(b=b||this.l){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.M)}catch(d){Uh(d)}}};
Jt.prototype.J=function(){window.removeEventListener("message",this.B);K.prototype.J.call(this)};function Kt(){this.j=[];this.isReady=!1;this.l={};var a=this.i=new Jt(!!A("WIDGET_ID_ENFORCE")),b=this.ic.bind(this);a.o=b;a.v=null;this.i.channel="widget";if(a=A("WIDGET_ID"))this.i.sessionId=a}
l=Kt.prototype;l.ic=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.l[a]||"onReady"===a||(this.addEventListener(a,Lt(this,a)),this.l[a]=!0)):this.kb(a,b,c)};
l.kb=function(){};
function Lt(a,b){return function(c){return a.sendMessage(b,c)}}
...
function Mt(a,b){a.sendMessage("infoDelivery",b)}
...
l.dispose=function(){this.i=null};function Nt(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function Ot(a,b,c){if("string"===typeof a)return{videoId:a,startSeconds:b,suggestedQuality:c};b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}
function Pt(a,b,c,d){if(Qa(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function Qt(a){Kt.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.tc.bind(this));this.addEventListener("onVolumeChange",this.uc.bind(this));this.addEventListener("onApiChange",this.mc.bind(this));this.addEventListener("onPlaybackQualityChange",this.pc.bind(this));this.addEventListener("onPlaybackRateChange",this.qc.bind(this));this.addEventListener("onStateChange",this.sc.bind(this));this.addEventListener("onWebglSettingsChanged",
this.vc.bind(this))}
r(Qt,Kt);l=Qt.prototype;
l.kb=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Nt(a)){var d=b;if(Qa(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=Ot(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=Ot(e);break;case "loadPlaylist":case "cuePlaylist":e=Pt(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);Nt(a)&&Mt(this,this.Ya())}};
...
(a.videoUrl=this.api.getVideoUrl());this.api.getVideoContentRect&&(a.videoContentRect=this.api.getVideoContentRect());this.api.getProgressState&&(a.progressState=this.api.getProgressState());this.api.getPlaylist&&(a.playlist=this.api.getPlaylist());this.api.getPlaylistIndex&&(a.playlistIndex=this.api.getPlaylistIndex());this.api.getStoryboardFormat&&(a.storyboardFormat=this.api.getStoryboardFormat());Mt(this,a)};
l.pc=function(a){Mt(this,{playbackQuality:a})};
l.qc=function(a){Mt(this,{playbackRate:a})};
...
l.uc=function(){Mt(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
l.tc=function(a){a={currentTime:a,videoBytesLoaded:this.api.getVideoBytesLoaded(),videoLoadedFraction:this.api.getVideoLoadedFraction(),currentTimeLastUpdated_:Date.now()/1E3,playbackRate:this.api.getPlaybackRate(),mediaReferenceTime:this.api.getMediaReferenceTime()};this.api.getProgressState&&(a.progressState=this.api.getProgressState());Mt(this,a)};
l.vc=function(){var a={sphericalProperties:this.api.getSphericalProperties()};Mt(this,a)};
l.dispose=function(){Kt.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function Rt(a){K.call(this);this.j={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.Eb,this)}
r(Rt,K);l=Rt.prototype;l.start=function(){this.started||this.i()||(this.started=!0,this.connection.ma("RECEIVING"))};
l.ma=function(a,b){this.started&&!this.i()&&this.connection.ma(a,b)};
l.Eb=function(a,b,c){if(this.started&&!this.i()){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=St(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=Tt(a,c))&&this.ma(a,c))}}};
...
l.J=function(){var a=this.connection;a.i()||kg(a.j,"command",this.Eb,this);this.connection=null;for(var b in this.j)this.j.hasOwnProperty(b)&&this.removeListener(b);K.prototype.J.call(this)};function Ut(a,b){Rt.call(this,b);this.api=a;this.start()}
r(Ut,Rt);Ut.prototype.addEventListener=function(a,b){this.api.addEventListener(a,b)};
Ut.prototype.removeEventListener=function(a,b){this.api.removeEventListener(a,b)};
function St(a,b){switch(a){case "loadVideoById":return a=Ot(b),[a];case "cueVideoById":return a=Ot(b),[a];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return a=Pt(b),[a];case "cuePlaylist":return a=Pt(b),[a];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
case "setShuffle":return[b.shufflePlaylist];case "getOptions":return[b.module];case "getOption":return[b.module,b.option];case "setOption":return[b.module,b.option,b.value];case "handleGlobalKeyDown":return[b.keyCode,b.shiftKey,b.ctrlKey,b.altKey,b.metaKey,b.key,b.code]}return[]}
function Tt(a,b){switch(a){case "isMuted":return{muted:b};case "getVolume":return{volume:b};case "getPlaybackRate":return{playbackRate:b};case "getAvailablePlaybackRates":return{availablePlaybackRates:b};case "getVideoLoadedFraction":return{videoLoadedFraction:b};case "getPlayerState":return{playerState:b};case "getCurrentTime":return{currentTime:b};case "getPlaybackQuality":return{playbackQuality:b};case "getAvailableQualityLevels":return{availableQualityLevels:b};case "getDuration":return{duration:b};
case "getVideoUrl":return{videoUrl:b};case "getVideoEmbedCode":return{videoEmbedCode:b};case "getPlaylist":return{playlist:b};case "getPlaylistIndex":return{playlistIndex:b};case "getOptions":return{options:b};case "getOption":return{option:b}}}
Ut.prototype.Xa=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Rt.prototype.Xa.call(this,a,b)};
Ut.prototype.J=function(){Rt.prototype.J.call(this);delete this.api};function Vt(a){a=void 0===a?!1:a;K.call(this);this.j=new L(a);pe(this,Xa(ne,this.j))}
Ya(Vt,K);Vt.prototype.subscribe=function(a,b,c){return this.i()?0:this.j.subscribe(a,b,c)};
Vt.prototype.m=function(a,b){this.i()||this.j.ka.apply(this.j,arguments)};function Wt(a,b,c){Vt.call(this);this.l=a;this.destination=b;this.id=c}
r(Wt,Vt);Wt.prototype.ma=function(a,b){this.i()||this.l.ma(this.destination,this.id,a,b)};
Wt.prototype.J=function(){this.destination=this.l=null;Vt.prototype.J.call(this)};function Xt(a,b,c){K.call(this);this.destination=a;this.origin=c;this.j=mn(window,"message",this.l.bind(this));this.connection=new Wt(this,a,b);pe(this,Xa(ne,this.connection))}
r(Xt,K);Xt.prototype.ma=function(a,b,c,d){this.i()||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(Lf(a),this.origin))};
Xt.prototype.l=function(a){var b;if(b=!this.i())if(b=a.origin===this.origin)a:{b=this.destination;do{b:{var c=a.source;do{if(c===b){c=!0;break b}if(c===c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.connection,c.i()||c.m("command",b.command,b.data,a.origin))}};
Xt.prototype.J=function(){nn(this.j);this.destination=null;K.prototype.J.call(this)};function Yt(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||ub(b);this.assets=a.assets||{};this.attrs=a.attrs||ub(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Yt.prototype.clone=function(){var a=new Yt,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Na(c)?a[b]=ub(c):a[b]=c}return a};var Zt=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function $t(a){a=a||"";if(window.spf){var b=a.match(Zt);spf.style.load(a,b?b[1]:"",void 0)}else au(a)}
function au(a){var b=bu(a),c=document.getElementById(b),d=c&&Ws(c,"loaded");d||c&&!d||(c=cu(a,b,function(){Ws(c,"loaded")||(Us(c),Cn(b),mi(Xa(Dn,b),0))}))}
...
function bu(a){var b=Kd("A");Cb("This URL is never added to the DOM");Ub(b,new Mb(a,Nb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Zb(a)}
;function du(){K.call(this);this.j=[]}
r(du,K);du.prototype.J=function(){for(;this.j.length;){var a=this.j.pop();a.target.removeEventListener(a.name,a.la,void 0)}K.prototype.J.call(this)};function eu(){du.apply(this,arguments)}
r(eu,du);function fu(a,b,c,d){K.call(this);var e=this;this.N=b;this.webPlayerContextConfig=d;this.Ua=!1;this.api={};this.Ea=this.v=null;this.U=new L;this.j={};this.ga=this.Fa=this.elementId=this.Va=this.config=null;this.Z=!1;this.m=this.B=null;this.Ga={};this.Mb=["onReady"];this.lastError=null;this.lb=NaN;this.M={};this.Nb=new eu(this);this.oa=0;this.l=this.o=a;pe(this,Xa(ne,this.U));gu(this);hu(this);pe(this,Xa(ne,this.Nb));c?this.oa=mi(function(){e.loadNewVideoConfig(c)},0):d&&(iu(this),ju(this))}
r(fu,K);l=fu.prototype;l.getId=function(){return this.N};
l.loadNewVideoConfig=function(a){if(!this.i()){this.oa&&(ni(this.oa),this.oa=0);var b=a||{};b instanceof Yt||(b=new Yt(b));this.config=b;this.setConfig(a);ju(this);this.isReady()&&ku(this)}};
function iu(a){var b;a.webPlayerContextConfig?b=a.webPlayerContextConfig.rootElementId:b=a.config.attrs.id;a.elementId=b||a.elementId;"video-player"===a.elementId&&(a.elementId=a.N,a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.N:a.config.attrs.id=a.N);var c;(null==(c=a.l)?void 0:c.id)===a.elementId&&(a.elementId+="-player",a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.elementId:a.config.attrs.id=a.elementId)}
l.setConfig=function(a){this.Va=a;this.config=lu(a);iu(this);if(!this.Fa){var b;this.Fa=mu(this,(null==(b=this.config.args)?void 0:b.jsapicallback)||"onYouTubePlayerReady")}this.config.args?this.config.args.jsapicallback=null:this.config.args={jsapicallback:null};var c;if(null==(c=this.config)?0:c.attrs)a=this.config.attrs,(b=a.width)&&this.l&&(this.l.style.width=Yd(Number(b)||b)),(a=a.height)&&this.l&&(this.l.style.height=Yd(Number(a)||a))};
function ku(a){if(a.config&&!0!==a.config.loaded)if(a.config.loaded=!0,!a.config.args||"0"!==a.config.args.autoplay&&0!==a.config.args.autoplay&&!1!==a.config.args.autoplay){var b;a.api.loadVideoByPlayerVars(null!=(b=a.config.args)?b:null)}else a.api.cueVideoByPlayerVars(a.config.args)}
function nu(a){var b=!0,c=ou(a);c&&a.config&&(a=pu(a),b=Ws(c,"version")===a);return b&&!!z("yt.player.Application.create")}
function ju(a){if(!a.i()&&!a.Z){var b=nu(a);if(b&&"html5"===(ou(a)?"html5":null))a.ga="html5",a.isReady()||qu(a);else if(ru(a),a.ga="html5",b&&a.m&&a.o)a.o.appendChild(a.m),qu(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.B=function(){c=!0;var d=su(a,"player_bootstrap_method")?z("yt.player.Application.createAlternate")||z("yt.player.Application.create"):z("yt.player.Application.create");var e=a.config?lu(a.config):void 0;d&&d(a.o,e,a.webPlayerContextConfig);qu(a)};
a.Z=!0;b?a.B():($s(pu(a),a.B),(b=tu(a))&&$t(b),uu(a)&&!c&&y("yt.player.Application.create",null))}}}
function ou(a){var b=Jd(a.elementId);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.elementId));return b}
function qu(a){if(!a.i()){var b=ou(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);if(c){a.Z=!1;if(!su(a,"html5_remove_not_servable_check_killswitch")){var d;if((null==b?0:b.isNotServable)&&a.config&&(null==b?0:b.isNotServable(null==(d=a.config.args)?void 0:d.video_id)))return}vu(a)}else a.lb=mi(function(){qu(a)},50)}}
function vu(a){gu(a);a.Ua=!0;var b=ou(a);if(b){a.v=wu(a,b,"addEventListener");a.Ea=wu(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=wu(a,b,f))}}for(var g in a.j)a.j.hasOwnProperty(g)&&a.v&&a.v(g,a.j[g]);ku(a);a.Fa&&a.Fa(a.api);a.U.ka("onReady",a.api)}
function wu(a,b,c){var d=b[c];return function(){var e=Ja.apply(0,arguments);try{return a.lastError=null,d.apply(b,e)}catch(f){"sendAbandonmentPing"!==c&&(f.params=c,a.lastError=f,Bp(f))}}}
function gu(a){a.Ua=!1;if(a.Ea)for(var b in a.j)a.j.hasOwnProperty(b)&&a.Ea(b,a.j[b]);for(var c in a.M)a.M.hasOwnProperty(c)&&ni(Number(c));a.M={};a.v=null;a.Ea=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function hu(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){Cn("WATCH_LATER_VIDEO_ADDED",b)});
a.addEventListener("WATCH_LATER_VIDEO_REMOVED",function(b){Cn("WATCH_LATER_VIDEO_REMOVED",b)})}
l.addEventListener=function(a,b){var c=this,d=mu(this,b);d&&(0<=db(this.Mb,a)||this.j[a]||(b=xu(this,a),this.v&&this.v(a,b)),this.U.subscribe(a,d),"onReady"===a&&this.isReady()&&mi(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.i()||(b=mu(this,b))&&kg(this.U,a,b)};
function mu(a,b){var c=b;if("string"===typeof b){if(a.Ga[b])return a.Ga[b];c=function(){var d=Ja.apply(0,arguments),e=z(b);if(e)try{e.apply(x,d)}catch(f){Ap(f)}};
a.Ga[b]=c}return c?c:null}
function xu(a,b){var c="ytPlayer"+b+a.N;a.j[b]=c;x[c]=function(d){var e=mi(function(){if(!a.i()){a.U.ka(b,null!=d?d:void 0);var f=a.M,g=String(e);g in f&&delete f[g]}},0);
pb(a.M,String(e))};
return c}
l.getPlayerType=function(){return this.ga||(ou(this)?"html5":null)};
l.getLastError=function(){return this.lastError};
function ru(a){a.cancel();gu(a);a.ga=null;a.config&&(a.config.loaded=!1);var b=ou(a);b&&(nu(a)||!uu(a)?a.m=b:(b&&b.destroy&&b.destroy(),a.m=null));if(a.o)for(a=a.o;b=a.firstChild;)a.removeChild(b)}
l.cancel=function(){this.B&&ft(pu(this),this.B);ni(this.lb);this.Z=!1};
l.J=function(){ru(this);if(this.m&&this.config&&this.m.destroy)try{this.m.destroy()}catch(b){Ap(b)}this.Ga=null;for(var a in this.j)this.j.hasOwnProperty(a)&&(x[this.j[a]]=null);this.Va=this.config=this.api=null;delete this.o;delete this.l;K.prototype.J.call(this)};
function uu(a){var b,c;a=null==(b=a.config)?void 0:null==(c=b.args)?void 0:c.fflags;return!!a&&-1!==a.indexOf("player_destroy_old_version=true")}
function pu(a){return a.webPlayerContextConfig?a.webPlayerContextConfig.jsUrl:(a=a.config.assets)?a.js:""}
function tu(a){return a.webPlayerContextConfig?a.webPlayerContextConfig.cssUrl:(a=a.config.assets)?a.css:""}
function su(a,b){if(a.webPlayerContextConfig)var c=a.webPlayerContextConfig.serializedExperimentFlags;else{var d;if(null==(d=a.config)?0:d.args)c=a.config.args.fflags}return"true"===$h(c||"","&")[b]}
function lu(a){for(var b={},c=p(Object.keys(a)),d=c.next();!d.done;d=c.next()){d=d.value;var e=a[d];b[d]="object"===typeof e?ub(e):e}return b}
;var yu={},zu="player_uid_"+(1E9*Math.random()>>>0);function Au(a,b,c){var d="player";c=void 0===c?!0:c;d="string"===typeof d?Jd(d):d;var e=zu+"_"+Ra(d),f=yu[e];if(f&&c)return Bu(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new fu(d,e,a,b);yu[e]=f;Cn("player-added",f.api);pe(f,function(){delete yu[f.getId()]});
return f.api}
function Bu(a,b){return b&&b.serializedExperimentFlags?b.serializedExperimentFlags.includes("web_player_remove_playerproxy=true"):a&&a.args&&a.args.fflags?a.args.fflags.includes("web_player_remove_playerproxy=true"):!1}
;var Cu=null,Du=null,Eu=null;function Fu(){var a=Cu.getVideoData(1);a=a.title?a.title+" - YouTube":"YouTube";document.title!==a&&(document.title=a)}
;function Gu(a,b,c){a="ST-"+Zb(a).toString(36);b=b?fc(b):"";c=c||5;gq()&&Yi(a,b,c)}
;function Hu(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=A("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=A("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=cc(window.location.href);g&&f.push(g);g=cc(d);if(0<=db(f,g)||!g&&0==d.lastIndexOf("/",0))if(M("autoescape_tempdata_url")&&(f=document.createElement("a"),Ub(f,d),d=f.href),d&&(d=dc(d),f=d.indexOf("#"),d=0>f?d:d.slice(0,f)))if(e&&!b.csn&&(b.itct||b.ved)&&(b=Object.assign({csn:Tp()},b)),h){var h=parseInt(h,10);isFinite(h)&&0<h&&
Gu(d,b,h)}else Gu(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=gc(a,k)+m;var u=void 0===u?Xd:u;a:{u=void 0===u?Xd:u;for(k=0;k<u.length;++k)if(m=u[k],m instanceof Sd&&m.isValid(a)){u=new Dd(a,Bd);break a}u=void 0}c.href=Fd(u||Ed)}return!0}
;y("yt.setConfig",Kh);y("yt.config.set",Kh);y("yt.setMsg",Yp);y("yt.msgs.set",Yp);y("yt.logging.errors.log",Ap);
y("writeEmbed",function(){var a=A("PLAYER_CONFIG");if(!a){var b=A("PLAYER_VARS");b&&(a={args:b})}oq(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=A("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);M("embeds_js_api_set_1p_cookie")&&(c=ei(window.location.href),c.embedsTokenValue&&(a.args.embedsTokenValue=c.embedsTokenValue));Mr();if((c=A("WEB_PLAYER_CONTEXT_CONFIGS"))&&
"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c){c=c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;if(!c.serializedForcedExperimentIds){var d=ei(window.location.href);d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}Cu=Au(a,c,!1)}else Cu=Au(a);Cu.addEventListener("onVideoDataChange",Fu);a=A("POST_MESSAGE_ID","player");A("ENABLE_JS_API")?Eu=new Qt(Cu):A("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(Du=new Xt(window.parent,a,b),Eu=new Ut(Cu,Du.connection));
jt();M("ytidb_create_logger_embed_killswitch")||Tj();a={};Et||(Et=new Dt);Et.install((a.flush_logs={la:function(){Io()}},a));
M("networkless_logging_web_embedded")&&(M("embeds_web_enable_new_nwl")?Fm():Nm());M("ytidb_clear_embedded_player")&&$e.O(function(){var e;if(!ss){yq||(yq=new vq);var f=yq;var g={hc:rs,Kb:qs};f.providers.set(g.hc,g);g={ob:{feedbackEndpoint:Jq(ms),modifyChannelNotificationPreferenceEndpoint:Jq(ns),playlistEditEndpoint:Jq(os),subscribeEndpoint:Jq(ks),unsubscribeEndpoint:Jq(ls),webPlayerShareEntityServiceEndpoint:Jq(ps)}};var h=M("web_enable_client_location_service")?Fq.getInstance():void 0,k={};h&&(k.client_location=
h);if(void 0===m){pq.i||(pq.i=new pq);var m=pq.i}void 0===e&&(e=f.resolve(rs));$r(g,e,m,k);ss=Zr.i}Ts()})});
var Iu=Sh(function(){Rr();var a=bj.getInstance(),b=ej(119),c=1<window.devicePixelRatio;if(document.body&&yf(document.body,"exp-invert-logo"))if(c&&!yf(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!yf(d,"inverted-hdpi")){var e=wf(d);xf(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&yf(document.body,"inverted-hdpi")&&zf();if(b!=c){b="f"+(Math.floor(119/31)+1);d=fj(b)||0;d=c?d|67108864:d&-67108865;0==d?delete aj[b]:(c=d.toString(16),
aj[b]=c.toString());c=!0;M("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.i;d=[];for(var f in aj)d.push(f+"="+encodeURIComponent(String(aj[f])));Yi(b,d.join("&"),63072E3,a.j,c)}Cs.i||(Cs.i=new Cs);a=Cs.i;f=16623;var g=void 0===g?{}:g;Object.values(Zp).includes(f)||(Bp(new Q("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.i.push({rootVe:f,key:g.key||""});a.s=[];a.D=[];g.rb?Fs(a,f,g):Gs(a,f,g)}),Ju=Sh(function(){Cu&&Cu.sendAbandonmentPing&&Cu.sendAbandonmentPing();
A("PL_ATT")&&rt.dispose();for(var a=$e,b=0,c=gt.length;b<c;b++)a.V(gt[b]);gt.length=0;et("//static.doubleclick.net/instream/ad_status.js");ht=!1;Kh("DCLKSTAT",0);oe(Eu,Du);Cu&&(Cu.removeEventListener("onVideoDataChange",Fu),Cu.destroy())});
window.addEventListener?(window.addEventListener("load",Iu),window.addEventListener("pagehide",Ju)):window.attachEvent&&(window.attachEvent("onload",Iu),window.attachEvent("onunload",Ju));y("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||st);y("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||tt);y("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||mt);y("yt.player.exports.navigate",z("yt.player.exports.navigate")||Hu);
y("yt.util.activity.init",z("yt.util.activity.init")||rn);y("yt.util.activity.getTimeSinceActive",z("yt.util.activity.getTimeSinceActive")||un);y("yt.util.activity.setTimestamp",z("yt.util.activity.setTimestamp")||sn);}).call(this);
